...
<template>
  <div id="e2e-app">
    <h1 data-testid="app-title">Verter E2E Test App</h1>

    <section data-testid="section-reactivity">
      <h2>Reactivity</h2>
      <RefCounter />
      <ReactiveObject />
    </section>

    <section data-testid="section-typescript">
      <h2>TypeScript</h2>
      <TypedPropsEmits />
      <WithDefaultsDemo />
      <DefineModelParent />
      <ExposeParent />
      <GenericComponent :items="genericItems" />
    </section>
    ...
    <section data-testid="section-slots">
      <h2>Slots</h2>
      <SlotShowcase />
    </section>

    <section data-testid="section-styles">
      <h2>Styles</h2>
      <ScopedCss />
      <CssModules />
      <ScssDemo />
    ...
    <section data-testid="section-composables">
      <h2>Composables</h2>
      <ComposableDemo />
      <ProvideInject />
    </section>
    ...
    <section data-testid="section-edge-cases">
      <h2>Edge Cases</h2>
      <FragmentRoots />
      <div data-testid="multi-instance-wrapper">
        <MultiInstance />
        <MultiInstance />
        <MultiInstance />
      </div>
