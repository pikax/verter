...
const CompA = markRaw(defineComponent({
  render() { return h('div', { 'data-testid': 'dynamic-comp-a' }, 'Component A') }
}))

const CompB = markRaw(defineComponent({
  render() { return h('div', { 'data-testid': 'dynamic-comp-b' }, 'Component B') }
}))

const CompC = markRaw(defineComponent({
  render() { return h('div', { 'data-testid': 'dynamic-comp-c' }, 'Component C') }
}))
