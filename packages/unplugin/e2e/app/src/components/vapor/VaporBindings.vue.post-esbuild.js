...
const t0 = _template(
  '<div data-testid="vapor-bindings"><span data-testid="vapor-styled">Styled text</span><button data-testid="vapor-color">Toggle Color</button><button data-testid="vapor-bigger">Bigger</button><span data-testid="vapor-color-val"> </span><span data-testid="vapor-size-val"> ',
);
