...
test.describe('Verter E2E Tests', () => {
  ...
  test('app title and all sections render', async ({ page }) => {
    ...
    const sections = [
      'section-reactivity', 'section-typescript', 'section-options-api',
      'section-directives', 'section-slots', 'section-styles',
      'section-composables', 'section-edge-cases', 'section-integration',
    ]
