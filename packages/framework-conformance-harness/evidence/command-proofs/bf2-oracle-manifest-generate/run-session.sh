...
SCRIPT="$REPO/packages/framework-conformance-harness/evidence/generate-official-case-manifests.mjs"
COMMITTED_VUE_TSV="$REPO/packages/framework-conformance-harness/evidence/vue-official-cases.tsv"
COMMITTED_SVELTE_TSV="$REPO/packages/framework-conformance-harness/evidence/svelte-official-cases.tsv"
...
echo "script_blob=$(git -C "$REPO" rev-parse HEAD:packages/framework-conformance-harness/evidence/generate-official-case-manifests.mjs)" | tee -a "$OUT_LOG"
