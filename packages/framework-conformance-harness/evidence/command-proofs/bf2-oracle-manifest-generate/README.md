...
- `--vue-modules`: a scratch `node_modules` produced by `npm ci` from the exact committed
  `packages/framework-conformance-harness/evidence/oracles/vue/package-lock.json`
...
- byte-identical `diff` against the committed
  `packages/framework-conformance-harness/evidence/{vue,svelte}-official-cases.tsv`.
...
cp packages/framework-conformance-harness/evidence/oracles/vue/package.json \
   packages/framework-conformance-harness/evidence/oracles/vue/package-lock.json \
