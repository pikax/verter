...
import { transpileTemplate } from "../../plugins/index.js";
import {
  getAccessors,
  PrefixSTR,
} from "../../plugins/template/v2/transpile/transpile.js";
import { ParseContext, VerterASTBlock } from "../../parser/parser.js";
// import {
//   transpileTemplate,
//   WalkResult,
// } from "@verter/core/dist/plugins/index.js";

const OptionsExportName = PrefixSTR("ComponentOptions");
const BindingContextExportName = PrefixSTR("BindingContext");
const FullContextExportName = PrefixSTR("FullContext");
const DefaultOptions = PrefixSTR("default");
const ComponentExport = PrefixSTR("Component");
const GenericOptions = PrefixSTR("GenericOptions");
const ResolveRenderProps = PrefixSTR("resolveRenderProps");
const ResolveProps = PrefixSTR("resolveProps");
const ResolveExtraProps = PrefixSTR("resolveExtraProps");
const ResolveEmits = PrefixSTR("resolveEmits");
const ResolveSlots = PrefixSTR("resolveSlots");
const ResolveModels = PrefixSTR("resolveModels");
const PropsPropertyName = PrefixSTR("props");
const WithDefaultsPropsPropertyName = PrefixSTR("withDefaultsProps");
const EmitsPropertyName = PrefixSTR("emits");
const SlotsPropertyName = PrefixSTR("slots");
const ModelsPropertyName = PrefixSTR("models");
...
export function processRender(context: ParseContext) {
  ...
  const filename = "test.render.ts";
  const optionsFilename = "test.options.ts";
