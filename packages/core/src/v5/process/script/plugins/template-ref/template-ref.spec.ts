...
describe("process script plugin template-ref", () => {
  ...
  it("ref", () => {
    ...
    expect(result).toMatchInlineSnapshot(
      `"<template><div ref="a"/></template><script setup lang="js">let a = useTemplateRef<HTMLDivElement,"a">()</script>"`
    );
  });
  ...
  it("MyComp :ref='a'", () => {
    ...
    expect(result).toMatchInlineSnapshot(
      `"<template><Comp :ref="a"/></template><script setup lang="js">import Comp from './Comp.vue';let a = useTemplateRef<___VERTER___NormalisedComponents["Comp"],typeof a>()</script>"`
    );
  });
  ...
  it("MyComp :ref='foo'", () => {
    ...
    expect(result).toMatchInlineSnapshot(
      `"<template><my-comp :ref="foo"/></template><script setup lang="js">import MyComp from './Comp.vue';let a = useTemplateRef<___VERTER___NormalisedComponents["MyComp"],typeof foo>();const foo = 'test'</script>"`
    );
  });
  ...
  it("MyComp :ref='foo' with string matching", () => {
    ...
    expect(result).toMatchInlineSnapshot(
      `"<template><my-comp :ref="foo"/></template><script setup lang="js">import MyComp from './Comp.vue';let a = useTemplateRef<___VERTER___NormalisedComponents["MyComp"],typeof foo>('test');const foo = 'test'</script>"`
    );
  });
  ...
  it('unknown if :ref="foo"', () => {
    ...
    expect(result).toMatchInlineSnapshot(
      `"<template><my-comp :ref="foo"/></template><script setup lang="js">import MyComp from './Comp.vue';let a = useTemplateRef<unknown,typeof foo>('test');const foo = 'testx'</script>"`
    );
  });
  it("multiple MyComp :ref='foo' with string matching", () => {
    ...
    expect(result).toMatchInlineSnapshot(
      `"<template><my-comp :ref="foox"/></template><script setup lang="js">import MyComp from './Comp.vue';import Comp from './Comp.vue'; let a = useTemplateRef<___VERTER___NormalisedComponents["MyComp"],typeof foox>('test');const foo = 'test';const foox = 'test'</script>"`
    );
  });
  it("multiple MyComp :ref='foo' with string matching but incorrect", () => {
    ...
    expect(result).toMatchInlineSnapshot(
      `"<template><my-comp :ref="foox"/></template><script setup lang="js">import MyComp from './Comp.vue';import Comp from './Comp.vue'; let a = useTemplateRef<unknown,typeof foox>('test');const foo = 'test';const foox = 'testx'</script>"`
    );
  });
  ...
  it("MyComp :ref='foo.bar'", () => {
    ...
    expect(result).toMatchInlineSnapshot(
      `"<template><my-comp :ref="foo.bar"/></template><script setup lang="js">import MyComp from './Comp.vue';let a = useTemplateRef<___VERTER___NormalisedComponents["MyComp"],typeof foo.bar>();const foo = { bar:'test'}</script>"`
    );
  });
  ...
  it("components.MyComp ref", () => {
    ...
    expect(result).toMatchInlineSnapshot(
      `"<template><components.MyComp ref="a"/></template><script setup lang="js">import MyComp from './Comp.vue';let a = useTemplateRef<___VERTER___NormalisedComponents["components"]["MyComp"],"a">();const components = {MyComp}</script>"`
    );
  });
  ...
  it('component is="div"', () => {
    ...
    expect(result).toMatchInlineSnapshot(
      `"<template><component is="div" ref="a"/></template><script setup lang="js">let a = useTemplateRef<HTMLDivElement,"a">()</script>"`
    );
  });
  it('component :is="foo"', () => {
    const { result } = parse(
    ...
    expect(result).toMatchInlineSnapshot(
      `"<template><component :is="foo" ref="a"/></template><script setup lang="js">let a = useTemplateRef<typeof foo,"a">();let foo = 'div'</script>"`
    );
  });
  it('component :is="true ? "div" : "span""', () => {
    ...
    expect(result).toMatchInlineSnapshot(
      `"<template><component :is="true ? 'div' : 'span'" ref="a"/></template><script setup lang="js">let a = useTemplateRef<HTMLDivElement|HTMLSpanElement,"a">()</script>"`
    );
  });
