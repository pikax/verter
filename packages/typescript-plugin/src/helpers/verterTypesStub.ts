// Minimal @verter/types stub for TypeScript plugin resolution.
// Served as a virtual module when @verter/types is not installed in the user's project.
//
// Canonical source: crates/verter_lsp/src/verter_types_stub.d.ts
// Box helper signatures: packages/types/src/vue/vue.macros.ts
// Keep in sync when Rust TSX codegen adds new @verter/types imports.

export const VERTER_TYPES_STUB = `\
import type {
  ShallowUnwrapRef,
...
export type AsyncComponent<T> = T extends abstract new (...args: any) => any
  ...
  : T extends (...args: any) => any
    ...
    : new (
        ...args: any[]
      ) => import("vue").ComponentPublicInstance<AsyncComponentOptionsProps<T>>;
