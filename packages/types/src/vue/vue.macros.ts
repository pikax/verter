...
>(
  ...
  [UniqueKey]?: [import("vue").DefineProps<T, BKeys>, Defaults];
};
...
> & {
  ...
  [UniqueKey]?: import("vue").ComponentOptionsBase<
    {},
    RawBindings,
    D,
    C,
...
>(
  ...
  [UniqueKey]?: PropOptions<T> & DefineModelOptions<T, G, S>;
};
...
>(
  ...
  [UniqueKey]?: [string, PropOptions<T> & DefineModelOptions<T, G, S>];
};
