...
describe("components helpers", () => {
  it("GetVueComponent: constructor returns instance type", () => {
  ...
  it("GetVueComponent: Vue built-ins (KeepAlive)", () => {
  ...
  it("GetVueComponent: Vue built-ins (Transition)", () => {
  ...
  it("GetVueComponent: Vue built-ins (TransitionGroup)", () => {
  ...
  it("GetVueComponent: Vue built-ins (Teleport)", () => {
  ...
  it("GetVueComponent: Vue built-ins (Suspense)", () => {
  ...
  it("GetVueComponent: function component returning VNode -> HTMLElement", () => {
  ...
  it("GetVueComponent: function component returning VNode[] -> Fragment", () => {
  ...
  it("GetVueComponent: function component returning void -> Comment", () => {
  ...
  it("GetVueComponent: non-component types yield never", () => {
    assertType<GetVueComponent<number>>({} as never);
  });

  it("DefineOptions: signature and return type", () => {
