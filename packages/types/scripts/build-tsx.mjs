...
function writeDistFiles(merged) {
  ...
  const jsOut = path.join(distDir, "tsx-string.js");
  const dtsOut = path.join(distDir, "tsx-string.d.ts");

  const js = `// Generated by scripts/build-tsx.mjs\nconst tsxMerged = \`${escaped}\`;\nexport default tsxMerged;\n`;
  const dts = `declare const tsxMerged: string;\nexport default tsxMerged;\n`;
...
function main() {
  ...
  console.log("✓ Built tsx merged outputs: dist/tsx.ts and dist/tsx-string.js");
}
