...
import {
  ...
  VerterDocument,
  VueDocument,
} from "@verter/language-server/src/v5/documents";
import {
  formatQuickInfo,
  itemToMarkdown,
  mapCompletion,
...
import { VueSubDocument } from "@verter/language-server/src/v5/documents/verter/vue/sub/sub";
import {
  VueBundleDocument,
  VueStyleDocument,
} from "@verter/language-server/src/v5/documents/verter/vue/sub";
