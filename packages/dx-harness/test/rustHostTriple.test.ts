...
// `../src/core/rustHostTriple.ts` (mirrored in
// `packages/vue-vscode/src/rustHostTriple.ts`): an inconclusive
...
import { hostRustTriples } from "../src/core/rustHostTriple.js";
...
async function withLinuxHost<T>(
  ...
  fn: (mod: typeof import("../src/core/rustHostTriple.js")) => T,
  ...
  vi.resetModules();
  try {
    const mod = await import("../src/core/rustHostTriple.js");
    return fn(mod);
  } finally {
