...
> [!IMPORTANT]
> Svelte support is **experimental — not yet validated in real-world use**. The preview uses the compiler-pinned Svelte 5.56.10 runtime. Unsupported runtime surfaces remain visible as diagnostics instead of being previewed as successful empty output.
