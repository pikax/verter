 ...
 * runtime ESM exists. Vue is the only entry today.
 */
export const PREVIEW_RUNTIME_FRAMEWORK_IDS: readonly string[] = ["vue"];
...
export function supportsRuntimePreview(id: string | null | undefined): boolean {
  return !!id && PREVIEW_RUNTIME_FRAMEWORK_IDS.includes(id);
}
