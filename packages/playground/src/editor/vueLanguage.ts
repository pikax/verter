...
const vueLanguage: monaco.languages.IMonarchLanguage = {
  ...
  tokenizer: {
    ...
    templateExpr: [[/\}/, "delimiter.bracket", "@pop"], { include: "@typescript" }],
    ...
    vueTemplate: [
      ...
      // Vue directives
      [
        /(@|v-on:|v-bind:|v-slot:|v-model|v-if|v-else-if|v-else|v-for|v-show|v-html|v-text|v-pre|v-cloak|v-once|v-memo|v-)/,
        "attribute.name",
      ],
      [/(:|@|#)[\w.-]+/, "attribute.name"],
