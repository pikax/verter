...
__VerterUseDirect(Picker, __VerterUse_7d12abeb7579a548, "items");
__VerterUseDirect(Picker, __VerterUse_7d12abeb7579a548, "field");
__VerterUseDirect(Picker, __VerterUse_7d12abeb7579a548, "format");
__VerterUseDirect(Picker, __VerterUse_7d12abeb7579a548, "onPick");
...
__VerterUseDirect(BarrelPicker, __VerterUse_de28af435ed10d58, "items");
__VerterUseDirect(BarrelPicker, __VerterUse_de28af435ed10d58, "field");
__VerterUseDirect(BarrelPicker, __VerterUse_de28af435ed10d58, "format");
__VerterUseDirect(BarrelPicker, __VerterUse_de28af435ed10d58, "onPick");
...
__VerterUseDirect(pickers.RowPicker, __VerterUse_0b8d07d8215f8d9f, "items");
__VerterUseDirect(pickers.RowPicker, __VerterUse_0b8d07d8215f8d9f, "field");
__VerterUseDirect(pickers.RowPicker, __VerterUse_0b8d07d8215f8d9f, "format");
...
__VerterUseDirect(Counter, __VerterUse_c00ddc48b3efc0e3, "count");
__VerterUseDirect(Counter, __VerterUse_c00ddc48b3efc0e3, "onBump");
...
__VerterUseDirect(Choice, __VerterUse_73fa95a4c37e26b8, "value");
__VerterUseDirect(Choice, __VerterUse_73fa95a4c37e26b8, "options");
__VerterUseDirect(Choice, __VerterUse_73fa95a4c37e26b8, "onChange");
...
__VerterUseDirect(Badge, __VerterUse_38e3f1df3d80f389, "level");
__VerterUseDirect(Badge, __VerterUse_38e3f1df3d80f389, "onDismiss");
...
__VerterUseDirect(Cell, __VerterUse_d9fde548ef6c26b1, "value");
__VerterUseDirect(Cell, __VerterUse_d9fde548ef6c26b1, "render");
const __VerterUse_69386ace753053c3 = new (__VerterUseComponent(Shape, __VerterUseConstructor(Shape)))({ "kind": "circle", "radius": (1) });
__VerterUseDirect(Shape, __VerterUse_69386ace753053c3, "kind");
__VerterUseDirect(Shape, __VerterUse_69386ace753053c3, "radius");
const __VerterUse_be4d6146599d76b8 = new (__VerterUseComponent(Shape, __VerterUseConstructor(Shape)))({ "kind": "polygon", "sides": (5) });
__VerterUseDirect(Shape, __VerterUse_be4d6146599d76b8, "kind");
__VerterUseDirect(Shape, __VerterUse_be4d6146599d76b8, "sides");
...
__VerterUseDirect(Untyped, __VerterUse_88698eb00ab7e0aa, "anything");
const __VerterUse_0f68882e583e0974 = new (__VerterUseComponent(Gauge, __VerterUseConstructor(Gauge)))({ "unit": "celsius", "value": (21) });
__VerterUseDirect(Gauge, __VerterUse_0f68882e583e0974, "unit");
__VerterUseDirect(Gauge, __VerterUse_0f68882e583e0974, "value");
const __VerterUse_d206613c79de26f0 = new (__VerterUseComponent(Gauge, __VerterUseConstructor(Gauge)))({ "unit": "percent", "ratio": (0.5) });
__VerterUseDirect(Gauge, __VerterUse_d206613c79de26f0, "unit");
__VerterUseDirect(Gauge, __VerterUse_d206613c79de26f0, "ratio");
const __VerterUse_b5063f18761348d2 = new (__VerterUseComponent(Toggle, __VerterUseConstructor(Toggle)))({ "mode": "on", "level": (2) });
__VerterUseDirect(Toggle, __VerterUse_b5063f18761348d2, "mode");
__VerterUseDirect(Toggle, __VerterUse_b5063f18761348d2, "level");
const __VerterUse_254f2d410a2b7939 = new (__VerterUseComponent(Toggle, __VerterUseConstructor(Toggle)))({ "mode": "off", "reason": "idle" });
__VerterUseDirect(Toggle, __VerterUse_254f2d410a2b7939, "mode");
__VerterUseDirect(Toggle, __VerterUse_254f2d410a2b7939, "reason");
const __VerterUse_8465246605fe46b7 = new (__VerterUseComponent(Menu, __VerterUseConstructor(Menu)))({ "items": (['a']), "flag": (true) });
__VerterUseDirect(Menu, __VerterUse_8465246605fe46b7, "items");
__VerterUseDirect(Menu, __VerterUse_8465246605fe46b7, "flag");
const __VerterUse_593dab2aba76bd47 = new (__VerterUseComponent(Select, __VerterUseConstructor(Select)))({ "value": "a", "options": (['a']) });
__VerterUseDirect(Select, __VerterUse_593dab2aba76bd47, "value");
__VerterUseDirect(Select, __VerterUse_593dab2aba76bd47, "options");
const __VerterUse_9b18a6441c8960f4 = new (__VerterUseComponent(Mix, __VerterUseConstructor(Mix)))({ "kind": "g", "value": "v" });
__VerterUseDirect(Mix, __VerterUse_9b18a6441c8960f4, "kind");
__VerterUseDirect(Mix, __VerterUse_9b18a6441c8960f4, "value");
}
