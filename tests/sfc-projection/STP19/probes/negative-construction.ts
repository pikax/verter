...
__VerterUseDirect(Picker, __VerterUse_71e18c9859e6b45c, "items");
__VerterUseDirect(Picker, __VerterUse_71e18c9859e6b45c, "field");
__VerterUseDirect(Picker, __VerterUse_71e18c9859e6b45c, "format");
...
__VerterUseDirect(BarrelPicker, __VerterUse_4780fd1fea8c1598, "items");
__VerterUseDirect(BarrelPicker, __VerterUse_4780fd1fea8c1598, "field");
__VerterUseDirect(BarrelPicker, __VerterUse_4780fd1fea8c1598, "format");
const __VerterUse_4655af4bb204c4c0 = new (__VerterUseComponent(Counter, __VerterUseConstructor(Counter)))({ "count": ('1') });
__VerterUseDirect(Counter, __VerterUse_4655af4bb204c4c0, "count");
const __VerterUse_e981986d24437340 = new (__VerterUseComponent(Shape, __VerterUseConstructor(Shape)))({ "kind": "polygon", "sides": ('five') });
__VerterUseDirect(Shape, __VerterUse_e981986d24437340, "kind");
__VerterUseDirect(Shape, __VerterUse_e981986d24437340, "sides");
const __VerterUse_09fb2e698bdf541a = new (__VerterUseComponent(Select, __VerterUseConstructor(Select)))({ "label": (1) });
__VerterUseDirect(Select, __VerterUse_09fb2e698bdf541a, "label");
}
