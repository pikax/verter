...
export const LIVE_UNIVERSE = Object.freeze({
  claims: Object.freeze({
    ...
    "CLM-EVIDENCE": Object.freeze([
      ...
      "A-mapping-product-total",
      "A-mapping-product-complete",
      "A-projection-refuses-not-approximates",
      "A-projection-complete-and-lineage-addressed",
  ...
  statements: Object.freeze({
    ...
    "atom:A-mapping-product-total": "43092790cee48d45",
    "atom:A-mapping-product-complete": "19d02bf388181dcb",
    "atom:A-projection-refuses-not-approximates": "c3752877e50850c8",
    "atom:A-projection-complete-and-lineage-addressed": "40a1f882c59842c4",
    ...
    "row:Editor completion string-recovery route": "006486d0cb93bc9d",
    "row:Compact mapping product inside CodeTransform": "4be81ecea10db133",
    "row:Incremental-equivalence not-applicable scope": "4e98513bbadc7d87",
    "row:Bounded-work not-applicable scope": "d87d0b492231ac38",
    "row:Implementation baseline record": "58a9c6410e647b23",
    "row:Vue SFC auto-import restoration": "40c4bd8a70a701ae",
    "row:Unselected projection topologies": "e4c2c8c355b9eede",
    "row:Content-mapper projection plane": "cabc0b101d50a4b0",
    "row:Projection-path implementation baseline record": "1d3673b6d978f8cb",
    "row:Projection-plane incremental-equivalence not-applicable scope": "5c03232ac6812af1",
    "row:Projection-plane bounded-work not-applicable scope": "42ae62f8ff1e2dec",
    ...
    "control:CTL-ledger-row.observed": "2e9b5b92b81cf175",
    ...
    "control:CTL-targeted-selector.observed": "6fbe5f1003a0ef1f",
    "control:CTL-mapping-product-elision.mutation": "1fcb1cb8f3d5fa1f",
    "control:CTL-mapping-product-elision.observed": "69284bc6ba64123f",
    "control:CTL-content-mapper-clamp.mutation": "227decb3832a79c5",
    "control:CTL-content-mapper-clamp.observed": "b20734a17e1fc837",
  ...
  anchors: Object.freeze({
    ...
    "atom:A-mapping-product-total": "1e1aaa138752baf2",
    "atom:A-mapping-product-complete": "1e1aaa138752baf2",
    "atom:A-projection-refuses-not-approximates": "c12216729811a90c",
    "atom:A-projection-complete-and-lineage-addressed": "c12216729811a90c",
  ...
  rows: Object.freeze({
    deletion: Object.freeze([
      ...
      "Editor completion string-recovery route",
      "Unselected projection topologies",
    ]),
    survivor: Object.freeze([
      ...
      "Compact mapping product inside CodeTransform",
      "Incremental-equivalence not-applicable scope",
      "Bounded-work not-applicable scope",
      "Implementation baseline record",
      "Vue SFC auto-import restoration",
      "Content-mapper projection plane",
      "Projection-path implementation baseline record",
      "Projection-plane incremental-equivalence not-applicable scope",
      "Projection-plane bounded-work not-applicable scope",
    ]),
  }),
});
