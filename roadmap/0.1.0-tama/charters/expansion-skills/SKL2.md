...
- Verify the owning predecessor has deleted or structurally rejected: **duplicate agent-specific authority**. This node changes no production route.
- Verify the owning predecessor has deleted or structurally rejected: **enabled skill before forward tests**. This node changes no production route.
