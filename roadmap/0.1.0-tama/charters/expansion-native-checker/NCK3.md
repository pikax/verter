...
- **NCK2:** implemented ledger row for “Incremental diagnostic query and result domain”; ledger presence alone satisfies the predecessor. Its commit message, approximate timezone-bearing date, and optional PR are locator hints only.
