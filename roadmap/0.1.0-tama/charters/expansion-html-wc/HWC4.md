...
- **FMTH0:** implemented ledger row for “Native neutral-HTML formatter”; ledger presence alone satisfies the predecessor. Its commit message, approximate timezone-bearing date, and optional PR are locator hints only.
- **HWCI0:** implemented ledger row for “HTML/WC IDE and LSP capabilities”; ledger presence alone satisfies the predecessor. Its commit message, approximate timezone-bearing date, and optional PR are locator hints only.
- **HWCL0:** implemented ledger row for “HTML/WC diagnostics, lint, fixes, and code actions”; ledger presence alone satisfies the predecessor. Its commit message, approximate timezone-bearing date, and optional PR are locator hints only.
- **HWCP0:** implemented ledger row for “HTML/WC public-surface adapters”; ledger presence alone satisfies the predecessor. Its commit message, approximate timezone-bearing date, and optional PR are locator hints only.
