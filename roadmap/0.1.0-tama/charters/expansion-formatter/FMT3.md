...
- **FMTV0:** implemented ledger row for “Vue whole-document formatter and atomic cutover”; ledger presence alone satisfies the predecessor. Its commit message, approximate timezone-bearing date, and optional PR are locator hints only.
- **FMTS0:** implemented ledger row for “Svelte whole-document formatter and atomic cutover”; ledger presence alone satisfies the predecessor. Its commit message, approximate timezone-bearing date, and optional PR are locator hints only.
