...
Narrowing and structural returns. The current owner is **legacy flow resolver paths**. The final and sole owner is **sole shared flow authority**. This charter accepts one authority/migration/cutover boundary; it contains no independently dispatchable subblocks.
