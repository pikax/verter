...
**Predecessors:** `UAI0`, `UAO0`, `UAP0`, `UAM0`.
**Subblocks:** (1) compare the canonical DAG predecessors and implementation-ledger rows; (2) re-run only cross-family ownership, dependency, deletion, and identity invariants on one cumulative candidate; (3) run current Vue/Svelte regression and public capability truth; (4) prove formatter/lint/CLI/skills do not depend on this aggregate join; (5) independent three-lane candidate review; (6) fresh Codex Architect review and maintainer adoption without identity-bound receipts.
