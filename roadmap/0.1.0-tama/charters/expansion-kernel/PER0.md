<!-- unified-charter-v2
id=PER0
name=Cache/backend identity, cancellation, budgets, and zero work
phase=expansion
...
conflict_domains=source_lineage,semantic_cache_store,performance_evidence
...
charter=charters/expansion-kernel/PER0.md
...
Cache/backend identity, cancellation, budgets, and zero work. The current owner is **framework-shaped host/session registries and untagged public boundaries**. The final and sole owner is **typed immutable universal catalog and demand-selected kernel services**. This charter accepts one authority/migration/cutover boundary; it contains no independently dispatchable subblocks.
...
- **PER0-AC1 — ownership contract:** every inventoried outcome, consumer and displaced route has exactly one declared implementation/deletion owner. Validate contract artifacts and their negative controls; production deletion is acceptance of the later owner, not this documentation-only node.
