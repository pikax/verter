...
- **ENCT0:** implemented ledger row for “TCM and certified-TypeScript coordinate-boundary verifier”; ledger presence alone satisfies the predecessor. Its commit message, approximate timezone-bearing date, and optional PR are locator hints only.
- **ENCF0:** implemented ledger row for “NAPI, WASM, FFI, MCP, and CLI coordinate-boundary cutover”; ledger presence alone satisfies the predecessor. Its commit message, approximate timezone-bearing date, and optional PR are locator hints only.
