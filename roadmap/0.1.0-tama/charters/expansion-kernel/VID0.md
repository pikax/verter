...
**Acceptance:** the accepted unit lineage survives edits while revision/content keys change and no post-BR0 repair remains; Vue 2.6 and Vue 3 fixtures can coexist without behavior branches or cache collision; the same TSX bytes can carry mutually exclusive React/Solid 2 claims; Solid 1 cannot activate a Solid 2 profile and older htmx majors cannot activate an htmx 4 profile; “latest” and untagged string IDs fail schema validation.
