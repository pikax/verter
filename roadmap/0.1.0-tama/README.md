...
The contract-dependency, aggregate-memory, shipped-build and finalization correction is recorded in `decisions/2026-09-05-contract-dependency-and-closure-correction.md`. Its pending owners follow `contracts/resource-and-finalization.md`; known current/successor seams follow `contracts/successor-seams.md`. `programctl products` distinguishes product gates and release inclusion from implemented foundation counts without claiming execution evidence.
