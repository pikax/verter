...
fn build_known_file_index(known_ids: &[String]) -> HashMap<String, String> {
...
fn resolve_known_dependency_id(
    owner_id: &str,
    specifier: &str,
...
fn resolve_known_dependency_base(owner_id: &str, specifier: &str) -> Option<String> {
...
fn normalize_known_file_id(file_id: &str) -> String {
