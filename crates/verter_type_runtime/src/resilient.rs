    ...
    fn apply(&mut self, mutation: &DesiredMutation) {
        match mutation {
            ...
            DesiredMutation::RegisterCarrierMetadata {
                ...
                content,
                project_file_name,
            } => match self.carrier_registrations.entry(companion_path.clone()) {
            ...
            DesiredMutation::ActivateCarrier {
                ...
                if let Some(carrier) = self.carrier_registrations.get_mut(companion_path) {
                    carrier.source_path = source_path.clone();
                    carrier.project_file_name = project_file_name.clone();
                    carrier.active = true;
                }
