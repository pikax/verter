...
// ── Guard 1: no emitting/accepting wildcard arm in classifier / plan builder ────
...
#[test]
fn guard1_discriminates_an_accepting_wildcard_arm() {
...
// ── Guard 2: no verbatim source return in client expression rewriting ───────────
...
#[test]
fn guard2_discriminates_a_verbatim_source_return() {
    // DISCRIMINATION on inline strings.
...
// ── Guard 3: bare-rune classification is POSITION-SENSITIVE ──────────────────────
...
#[test]
fn guard3_discriminates_an_ungated_bare_rune_skip() {
...
// ── Guard 4: no `is_keyword` in the client element-safety path ───────────────────
...
#[test]
fn guard4_discriminates_an_is_keyword_element_check() {
    // DISCRIMINATION on inline strings.
    let banned =
...
// ── Guard 5: no raw element tag as a client DOM variable stem ─────────────────────
...
#[test]
fn guard5_discriminates_a_raw_tag_var_stem() {
    // DISCRIMINATION on inline strings.
    let banned_alloc =
...
// ── Guard 6: no client serializer path silently drops an accepted static attr ─────
...
#[test]
fn guard6_discriminates_an_accept_then_drop_static_attr_arm() {
