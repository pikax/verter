...
//! binary.
//!
//! Lives in a SUBDIRECTORY (`tests/svelte_guard_support/mod.rs`) so cargo
//! does not compile it as its own test binary; guards include it with
//! `mod svelte_guard_support;` + `use svelte_guard_support::strip_rust_comments;`.
