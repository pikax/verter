...
//!
//! This is the SYNTAX-side scan over the retained instance/module program. It owns
...
#[must_use]
pub fn instance_forces_definite_legacy(program: &Program<'_>) -> bool {
...
mod tests {
    use super::*;
    use crate::svelte::runtime::expr::reparse_module;
