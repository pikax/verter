...
pub struct NormalizedGolden {
    ...
    pub semantic_comment_signature: Vec<String>,
    pub css: CssTopology,
}
...
pub fn topology_diff(
    ...
    if expected.semantic_comment_signature != actual.semantic_comment_signature {
        out.push(TopologyDivergence::SemanticCommentSignature {
            expected: expected.semantic_comment_signature.clone(),
            actual: actual.semantic_comment_signature.clone(),
        });
    }
