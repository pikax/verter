...
#[test]
fn parse_lossless_is_hidden_at_the_crate_root() {
    let tests = trybuild::TestCases::new();
    tests.compile_fail("tests/compile-fail/parse_lossless_crate_root.rs");
}

#[test]
fn parse_lossless_is_hidden_at_its_module_path() {
    let tests = trybuild::TestCases::new();
    tests.compile_fail("tests/compile-fail/parse_lossless_module_path.rs");
}

#[test]
fn parser_route_is_hidden_at_the_crate_root() {
    let tests = trybuild::TestCases::new();
    tests.compile_fail("tests/compile-fail/parser_route_crate_root.rs");
}

#[test]
fn parser_route_is_hidden_at_its_module_path() {
    let tests = trybuild::TestCases::new();
    tests.compile_fail("tests/compile-fail/parser_route_module_path.rs");
}

#[test]
fn style_body_reject_code_is_hidden_at_the_crate_root() {
    let tests = trybuild::TestCases::new();
    tests.compile_fail("tests/compile-fail/style_body_reject_code_crate_root.rs");
}
