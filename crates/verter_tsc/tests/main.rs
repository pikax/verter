//! Single consolidated integration-test binary for `verter_tsc`.
//!
...
//! formerly-separate targets. The `diagnostics` fixtures live under
//! `tests/cases/fixtures/` beside the entry that consumes them.
