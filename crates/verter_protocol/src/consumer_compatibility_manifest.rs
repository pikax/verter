...
const CACHE_CLUSTER_SCHEMA_VERSION: CacheClusterSchemaVersion = CacheClusterSchemaVersion(11);
...
mod tests {
    ...
    fn public_hash_grammar_and_version_domains_are_closed() {
        ...
        assert_eq!(manifest.cache_cluster_schema_version.get(), 11);
        assert_eq!(manifest.component_meta_schema_version.get(), 12);
