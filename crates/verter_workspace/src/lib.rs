...
pub use resolver::{
    carrier_api_provider_path, carrier_ide_provider_path, path_is_carrier, path_is_vue_carrier,
    strip_carrier_extension, IdeProjectCompilerOptions, IdeProjectConfig, NativeProjectResolver,
    ProjectMembership, ProjectResolver, WorkspaceAlias,
};
