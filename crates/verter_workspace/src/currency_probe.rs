...
mod imp {
    ...
    declare_sites! {
        ...
        RESOLVE_CANDIDATE_READ => "  ..resolve: lazy-cache read + candidate clone",
        RESOLVE_SCREEN_EXACT   => "  ..resolve: screen candidates against exact fact",
        RESOLVE_EXACT_LOOKUP   => "  ..resolve: exact-table lookup + clone",
        RESOLVE_CONTEXT_SELECT => "  ..resolve: selected_context_for_path",
        RESOLVE_REUSE_FIND     => "  ..resolve: candidate reuse find (validates)",
        RESOLVE_REUSE_CTX      => "    ..find: complete_provider_context",
        RESOLVE_REUSE_QUERY    => "    ..find: query key build + eq",
        RESOLVE_REUSE_VALIDATE => "    ..find: signature.validates",
        ...
        OBS_SUPPRESSED         => "    [tally] repeat observations suppressed at record time",
