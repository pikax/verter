...
import { child as _child, next as _next, on as _on, withModifiers as _withModifiers, template as _template } from 'vue';
...
function render(_ctx, $props, $emit, $attrs, $slots) {
  ...
  _on(n2, "click", _withModifiers(_ctx.save, ["self"]))
  return n2
}
