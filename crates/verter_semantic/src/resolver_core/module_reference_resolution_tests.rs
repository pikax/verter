...
fn module_reference(
    analyzability: crate::analysis::ModuleReferenceAnalyzability,
    literal_specifier: Option<&str>,
    finite_specifiers: &[&str],
) -> crate::analysis::AnalyzedModuleReference {
    crate::analysis::AnalyzedModuleReference {
        syntax: crate::analysis::ModuleReferenceSyntax::DynamicImport,
        semantics: crate::analysis::ModuleReferenceSemantics::Import,
        is_type_only: false,
        span: Span::new(0, 1),
...
fn collect_resolvable_module_reference_specifiers_preserves_order_and_skips_unknown_dynamic() {
    let module_references = vec![
        ...
        module_reference(
            crate::analysis::ModuleReferenceAnalyzability::UnknownDynamic,
            None,
            &[],
        ),
    ];
