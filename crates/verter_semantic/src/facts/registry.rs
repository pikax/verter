//! Dependency-neutral fact registry types shared by workspace resolution,
//! semantic producers, and session caches.
//!
...
/// fact-based cache architecture. The separate 2-variant
