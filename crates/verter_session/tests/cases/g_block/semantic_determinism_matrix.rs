...
const STABLE_KEY_TABLE: &[StableKeyRow] = &[
    ...
    StableKeyRow { variant: "ClassExpressionInstance", domain: "anonymous authored types", inputs: "the class expression's authored position (logical source unit, owner and offset) plus its printed name and qualifier, and the instance surface's stable-key reference", residual: None },
