...
//!
//! Corpus coverage for the vendored Vue fixture at `/DashboardSearch.vue`.
...
fn corpus_audit_dashboard_search_produces_audit_record_or_documents_skip() {
    let src = include_str!("fixtures/DashboardSearch.vue");
    let result = AuditedRequest::builder()
        .files([("/DashboardSearch.vue", src)])
        .resolve_component_meta("/DashboardSearch.vue");
