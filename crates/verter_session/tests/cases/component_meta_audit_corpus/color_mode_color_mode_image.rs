...
//!
//! Corpus coverage for the vendored Vue fixture at `/color-mode/ColorModeImage.vue`.
...
fn corpus_audit_color_mode_color_mode_image_produces_audit_record_or_documents_skip() {
    let src = include_str!("fixtures/color-mode/ColorModeImage.vue");
    let result = AuditedRequest::builder()
        .files([("/color-mode/ColorModeImage.vue", src)])
        .resolve_component_meta("/color-mode/ColorModeImage.vue");
