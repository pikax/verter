...
const CRITICAL_RULE_GUARDS: &[(&str, &[&str])] = &[
    ...
    (
        ...
        &[
            // Leaf-dependency invariant is the workspace resolve-graph
            // closure walk, not a per-manifest TOML scan.
    ...
    (
        ...
        &[
            ...
            // (crates/verter_compiler/tests/cases/svelte_client_authored_value_routing_guard.rs).
