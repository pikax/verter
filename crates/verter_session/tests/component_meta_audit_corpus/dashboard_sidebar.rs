...
//!
//! Corpus coverage for the vendored Vue fixture at `/DashboardSidebar.vue`.
...
fn corpus_audit_dashboard_sidebar_produces_audit_record_or_documents_skip() {
    let src = include_str!("fixtures/DashboardSidebar.vue");
    let result = AuditedRequest::builder()
        .files([("/DashboardSidebar.vue", src)])
        .resolve_component_meta("/DashboardSidebar.vue");
