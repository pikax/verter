...
//!
//! Corpus coverage for the vendored Vue fixture at `/prose/Callout.vue`.
...
fn corpus_audit_prose_callout_produces_audit_record_or_documents_skip() {
    let src = include_str!("fixtures/prose/Callout.vue");
    let result = AuditedRequest::builder()
        .files([("/prose/Callout.vue", src)])
        .resolve_component_meta("/prose/Callout.vue");
