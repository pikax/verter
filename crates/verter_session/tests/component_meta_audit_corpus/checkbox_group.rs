...
//!
//! Corpus coverage for the vendored Vue fixture at `/CheckboxGroup.vue`.
...
fn corpus_audit_checkbox_group_produces_audit_record_or_documents_skip() {
    let src = include_str!("fixtures/CheckboxGroup.vue");
    let result = AuditedRequest::builder()
        .files([("/CheckboxGroup.vue", src)])
        .resolve_component_meta("/CheckboxGroup.vue");
