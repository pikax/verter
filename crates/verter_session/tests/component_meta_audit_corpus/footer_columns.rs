...
//!
//! Corpus coverage for the vendored Vue fixture at `/FooterColumns.vue`.
...
fn corpus_audit_footer_columns_produces_audit_record_or_documents_skip() {
    let src = include_str!("fixtures/FooterColumns.vue");
    let result = AuditedRequest::builder()
        .files([("/FooterColumns.vue", src)])
        .resolve_component_meta("/FooterColumns.vue");
