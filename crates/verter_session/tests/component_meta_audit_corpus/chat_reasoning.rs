...
//!
//! Corpus coverage for the vendored Vue fixture at `/ChatReasoning.vue`.
...
fn corpus_audit_chat_reasoning_produces_audit_record_or_documents_skip() {
    let src = include_str!("fixtures/ChatReasoning.vue");
    let result = AuditedRequest::builder()
        .files([("/ChatReasoning.vue", src)])
        .resolve_component_meta("/ChatReasoning.vue");
