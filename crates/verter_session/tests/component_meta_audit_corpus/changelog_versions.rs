...
//!
//! Corpus coverage for the vendored Vue fixture at `/ChangelogVersions.vue`.
...
fn corpus_audit_changelog_versions_produces_audit_record_or_documents_skip() {
    let src = include_str!("fixtures/ChangelogVersions.vue");
    let result = AuditedRequest::builder()
        .files([("/ChangelogVersions.vue", src)])
        .resolve_component_meta("/ChangelogVersions.vue");
