...
//!
//! Corpus coverage for the vendored Vue fixture at `/DashboardNavbar.vue`.
...
fn corpus_audit_dashboard_navbar_produces_audit_record_or_documents_skip() {
    let src = include_str!("fixtures/DashboardNavbar.vue");
    let result = AuditedRequest::builder()
        .files([("/DashboardNavbar.vue", src)])
        .resolve_component_meta("/DashboardNavbar.vue");
