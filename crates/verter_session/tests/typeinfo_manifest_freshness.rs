...
//! (`pnpm gen:typeinfo-manifest`) — the SOLE writer of those files —
//! joining the authoritative §10.4.1 row→block partition with the live
//! `#[ignore]` discovery and the Capability Map. Whenever the generator
