...
//! The authoritative §10.4.1 row→block partition is the source ONLY for
...
//! `BLOCK_VERIFICATION_LABELS`, the prereq/mechanism maps), NOT from
//! §10.4.1. The guards below only diff/fail — they never write the
...
// authoritative §10.4.1 row→block partition is the source ONLY for each
...
// Python maps, NOT from §10.4.1. The guards below only diff/fail, never
