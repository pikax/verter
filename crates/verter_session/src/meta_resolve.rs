...
pub(crate) use dep_signature::{
    ...
    reset_bfs_compute_counter_for_test, with_bfs_child_refs_observer_for_test,
...
pub(crate) use materialize::{
    ...
    lowered_needs_member_route_materialization, lowered_preserve_package_backed_symbolic_refs,
    ...
    produce_one_macro_object_shape, projection_result_beats_solver_shape,
    registry_entry_to_expanded_shape,
    synthesize_define_props_shape_from_known_surface_with_authority,
    top_level_imported_ref_can_stay_symbolic, type_expr_has_non_object_top_level_surface,
    type_expr_has_package_backed_object_like_root, type_expr_is_slots_member_route,
    MacroShapeSource,
};
#[cfg(test)]
...
pub(crate) use registry_materialize::{
    ...
    nested_symbolic_member_route_should_stay_symbolic, preserve_nested_symbolic_member_routes,
