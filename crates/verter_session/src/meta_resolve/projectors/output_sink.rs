...
///   interior failure conservatively fails the whole position; the
///   fine-grained provenance that would let a proven-absent nested
///   position inside a deref'd body keep rendering `unknown` is the
///   deferred half of `docs/arch/stage10-b6-p4b-debt-rows.md` DEBT ROW #2.
