...
static LIB_LIVE_GUARD_BINDINGS: &[LibGuardBinding] = &[
    ...
    lib_guard!(FlowCompletionCarrierInventoryIsClosed => crate::flow_completion_inventory_tests::every_site_row_is_reached_and_every_reached_row_is_listed),
    lib_guard!(FlowCompletionCarriersPublishTheCheckersAnswer => crate::flow_completion_inventory_tests::every_probe_observes_the_checkers_answer),
    lib_guard!(ALabeledTryOrThrowSuffixNeverAdmitsAFabricatedUndefinedContributor => crate::project_semantic_dispatch::flow_return_tests::a_labeled_try_or_throw_suffix_never_admits_a_fabricated_undefined_contributor),
