...
//!   `ImportedRegistryDb`, `MaterializeStructureDb`.
//!   Each wraps a shared
...
// `MaterializeStructureDb` uses `invalidate_for_canonical` instead of
// `invalidate_canonical`. Keep the trait wiring uniform.
