...
fn unclassifiable_in_guard_arms_remain_possible_degrade_and_never_warm() {
    ...
    let cases = [
        ...
        Case {
            ...
            checker: "0 | { k: number; }",
            rendered: "Union({ k: number } | TypeParam(T) | 0)",
            degradation: Degr::FlowGap(FlowGap::GuardNarrowing),
            warm: false,
        },
        ...
        Case {
            ...
            checker: "A | B | 0",
            rendered: "Union(DeclRef(B) | DeclRef(A) | 0)",
            degradation: Degr::None,
            warm: true,
        },
        Case {
...
fn deep_path_guards_narrow_the_parent_reference_not_the_root() {
    ...
    let cases = [
        Case {
            ...
            checker: "0 | M1 | M2",
            rendered: "Union(DeclRef(M2) | DeclRef(M1) | 0)",
            degradation: Degr::None,
            warm: true,
        },
        Case {
        ...
        Case {
            ...
            checker: "0 | Y1 | Y2",
            rendered: "Union(DeclRef(Y2) | DeclRef(Y1) | 0)",
            degradation: Degr::None,
            warm: true,
        },
        Case {
        ...
        Case {
            ...
            checker: "0 | N1 | N2",
            rendered: "Union(0 | DeclRef(N2) | DeclRef(N1))",
            degradation: Degr::None,
            warm: true,
        },
        Case {
...
fn truthiness_domain_facts_narrow_like_the_checker() {
    ...
    let cases = [
        ...
        Case {
            ...
            checker: "1 | { v: string; }",
            rendered: "Union({ v: TemplateLiteral(…) } | 1)",
            degradation: Degr::None,
            warm: true,
        },
        ...
        Case {
            ...
            rendered: "Union(1 | { v: Union({ y: number } | undefined) })",
            degradation: Degr::FlowGap(FlowGap::GuardNarrowing),
            warm: false,
        },
        ...
        Case {
            ...
            rendered: "Union({ v: Union(Intersection(string & { x: 1 }) | number) } | 1)",
            degradation: Degr::None,
            warm: true,
        },
        ...
        Case {
            ...
            rendered: "Union({ v: Union(KeyOf(TypeParam(T)) | 0) } | 1)",
            degradation: Degr::FlowGap(FlowGap::GuardNarrowing),
            warm: false,
        },
        ...
        Case {
            ...
            checker: "1 | { v: 0 | T; }",
            rendered: "Union({ v: Union(TypeParam(T) | 0) } | 1)",
            degradation: Degr::None,
            warm: true,
        },
    ];
...
fn as_const_literal_identity_survives_evolving_assignments_and_joins() {
    ...
    let cases: [(&str, &str, String, Degr, bool); 12] = [
        ...
        (
            ...
            single_v_object_json(&union2(&prim("number"), &prim("string"))),
            Degr::None,
            true,
        ),
        (
...
fn in_guard_presence_is_separate_from_value_undefined() {
    ...
    let cases: [(&str, &str, String, Degr, bool); 8] = [
        ...
        (
            ...
            obj_v(r#"{"kind":"union","types":[{"kind":"primitive","name":"number"},{"kind":"primitive","name":"string"},{"kind":"primitive","name":"undefined"}]}"#),
            Degr::None,
            true,
        ),
        (
        ...
        (
            ...
            "type T = { k: string }\nfunction f(x: T) { if (\"k\" in x) { return { v: x.k } } return { v: 0 } }",
            union2(&obj_v(num), &obj_v(r#"{"kind":"primitive","name":"string"}"#)),
            Degr::None,
            true,
        ),
        (
