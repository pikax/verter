...
impl IntrinsicImpl {
    ...
    /// registry and [`crate::project_semantic_dispatch::ProjectSemanticDispatch`].
    /// The dispatch looks up a name through [`IntrinsicRegistry::lookup`] and
    /// routes supported hits onto the matching built-in utility reducer.
    #[must_use]
