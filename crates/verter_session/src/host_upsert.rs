...
impl VerterHost {
    ...
    pub(crate) fn upsert_via_scheduler_with_options(
        ...
        // carry complete cross-file signatures for every downstream
        // cache (route surface, multi-candidate route_owned_shallow,
        // cross-file fact-aware imported roots), the per-canonical
