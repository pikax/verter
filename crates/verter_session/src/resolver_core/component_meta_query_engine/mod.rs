...
pub(crate) use surface::{
    ...
    arc_routed_expr_surface_cache_key, projected_surface_from_semantic_node,
    projected_surface_to_expanded_shape, projected_surface_to_type_expr, semantic_query_error_raw,
    surface_view_to_projected_surface, type_expr_contains_semantic_miss,
    type_expr_has_any_object_arm, type_expr_is_expanded_surface,
};
...
use surface::{
    ...
    build_default_type_param_substitutions, dispatch_route_expr_is_materialized,
    filtered_projected_surface, prepared_substitution_key,
...
use helpers::{
    is_builtin_name, is_package_canonical, is_package_source,
    prepared_decl_keeps_raw_symbolic_non_object_alias, prepared_member_body_stays_shallow,
    projected_surface_member_names, resolve_imported_registry_symbol_with_budget,
