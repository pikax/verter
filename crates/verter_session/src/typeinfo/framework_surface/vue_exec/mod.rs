...
// The per-surface normalizers live in focused submodules. Re-export the ones
// the executor below and external consumers reach through the flat
// `vue_exec::props_from_typeinfo_surface` path.
