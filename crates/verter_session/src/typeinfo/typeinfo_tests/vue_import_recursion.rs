...
//! content-free — the live `whole_hash` is re-sourced at value-compute time from
//! the `ensure_indexed_ready_serve(base.defining_canonical)` serve's
//! `indexed.whole_hash`, NOT carried in the key. It is the SAME keyed identity both
