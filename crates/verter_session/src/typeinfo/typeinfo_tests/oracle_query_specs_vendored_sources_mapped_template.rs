...
// rows (`mapped_template.ts` + `template_literal_inference.ts`), grouped
// separately so this oracle feature family's byte authority remains focused.
// `include!`'d by `oracle_query_specs.rs`
