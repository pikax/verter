...
use crate::{
    ...
    syntax_kai::{
        ...
        plugins::code_gen::{
            template::helper::{
                apply_dynamic_arg_prefix, build_patch_flag_suffix, build_prefixed_value,
                capitalize_first, escape_js_string, patch_bindings,
            },
...
use super::{ChildKind, DirectiveEntry, StateStack};
...
/// Emit `_withDirectives(` prefix and `, [[...]])` suffix for runtime directives.
