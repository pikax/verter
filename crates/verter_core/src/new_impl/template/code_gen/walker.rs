...
use crate::new_impl::ast::types::{AstNodeKind, TemplateAst};
use crate::new_impl::template::oxc::types::{OxcNodeData, OxcParsedAst};
...
mod tests {
    ...
    use crate::new_impl::template::oxc::types::{OxcNodeData, OxcParsedAst, OxcParsedExpression};
    ...
    impl<'alloc> TemplateCodeGen<'alloc> for RecordingCodeGen {
        ...
        fn enter_element(
            ...
            id: NodeId,
            _el: &ElementNode,
            _oxc: Option<&crate::new_impl::template::oxc::types::OxcParsedElement<'alloc>>,
            _source: &'alloc str,
            _out: &mut CodeGenOutput<'alloc>,
        ) {
