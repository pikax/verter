...
// Tracked: docs/arch/refactor/rev11/charters/expansion-language-service/LSO6.md → "Deferred test
// ledger (#[ignore] tracking)" (un-ignore when the in-memory child-API project
// setup is deterministic).
#[ignore = "tsserver in-memory child-API project setup returns 'No content available' (pre-existing multi-file-sync fragility); tracked in docs/arch/refactor/rev11/charters/expansion-language-service/LSO6.md → Deferred test ledger"]
#[tokio::test]
...
// deterministic).
#[ignore = "tsserver plugin + open-child-IDE project setup returns 'No content available' (pre-existing multi-file-sync fragility); tracked in docs/arch/refactor/rev11/charters/expansion-language-service/LSO6.md → Deferred test ledger"]
#[tokio::test]
