...
function requireSfc$1() {
  ...
  function extractBlocksFromDescriptor(descriptor) {
    ...
    for (let i = 0; i < sfcBlocks.length; i++) {
      ...
      const nextOffsetEnd =
        ((_a = sfcBlocks[i + 1]) == null ? void 0 : _a.loc.start.offset) ?? source.length;
      ...
      if (!tagMatch.groups || tagMatch.index === void 0) continue;
      ...
      const tagCloseIndex =
        endTagOffset + ((tagEndMatch == null ? void 0 : tagEndMatch.index) ?? 0);
      const endTagPos = {
        start: tagCloseIndex,
...
function requireUtils$3() {
  ...
  (function (exports) {
    var __createBinding =
      (utils$3 && utils$3.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
  ...
  function templateWalk(root, options, context) {
    function visit(node, parent, context2, parentContext) {
      ...
      const returnedContext =
        (_a = options.enter) == null
          ? void 0
          : _a.call(options, node, parent, context2, parentContext);
      const overrideContext = returnedContext || context2;
      const childContext = {
        conditions:
          ((_b = parentContext.conditions) == null ? void 0 : _b.length) > 0
      ...
      (_c = options.leave) == null
        ? void 0
        : _c.call(options, node, parent, context2, parentContext);
    }
...
function requireShared() {
  ...
  (function (exports) {
    var __createBinding =
      (shared$1 && shared$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (shared$1 && shared$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
function requireNode() {
  ...
  function patchBabelNodeLoc(node2, templateNode) {
    if (node2.loc) {
      ...
      node2.loc.source =
        node2.loc.identifierName ?? // @ts-expect-error not part of loc
  ...
  (function (module, exports) {
    (function (global, factory) {
      ...
      lp$2.readToken = function () {
        for (;;) {
          try {
            this.toks.next();
            if (
              this.toks.type === acorn.tokTypes.dot &&
            ...
            this.resetTo(pos);
            if (replace === true) {
              replace = { start: pos, end: pos, type: acorn.tokTypes.name, value: dummyValue };
            }
            if (replace) {
              if (this.options.locations) {
        ...
        switch (starttype) {
          ...
          case acorn.tokTypes._switch:
            ...
            while (!this.closes(acorn.tokTypes.braceR, blockIndent, line, true)) {
              if (
                this.tok.type === acorn.tokTypes._case ||
                this.tok.type === acorn.tokTypes._default
              ) {
      ...
      lp$1.parseClassElement = function () {
        ...
        if (!keyName && ecmaVersion >= 8 && this.eatContextual("async")) {
          if (
            (this.isClassElementNameStart() || this.toks.type === acorn.tokTypes.star) &&
            !this.canInsertSemicolon()
          ) {
            isAsync = true;
          } else {
        ...
        if (
          ecmaVersion < 13 ||
          this.toks.type === acorn.tokTypes.parenL ||
          kind !== "method" ||
          isGenerator ||
          isAsync
        ) {
      ...
      lp$1.parseExport = function () {
        ...
        if (this.eat(acorn.tokTypes._default)) {
          ...
          var isAsync;
          if (
            this.tok.type === acorn.tokTypes._function ||
      ...
      lp$1.parseWithClause = function () {
        ...
        while (
          ...
          attr.key =
            this.tok.type === acorn.tokTypes.string ? this.parseExprAtom() : this.parseIdent();
      ...
      lp.parseMaybeAssign = function (noIn) {
        ...
        if (this.tok.type.isAssign) {
          ...
          node$1.left =
            this.tok.type === acorn.tokTypes.eq ? this.toAssignable(left) : this.checkLVal(left);
          this.next();
      ...
      lp.parseSubscripts = function (base, start, noCalls, startIndent, line) {
        ...
        for (;;) {
          ...
          var maybeAsyncArrow =
            base.type === "Identifier" && base.name === "async" && !this.canInsertSemicolon();
          ...
          if (
            (optional &&
              this.tok.type !== acorn.tokTypes.parenL &&
              this.tok.type !== acorn.tokTypes.bracketL &&
              this.tok.type !== acorn.tokTypes.backQuote) ||
            this.eat(acorn.tokTypes.dot)
          ) {
            var node = this.startNodeAt(start);
            node.object = base;
            if (
      ...
      lp.parseObj = function () {
        ...
        while (!this.closes(acorn.tokTypes.braceR, indent, line)) {
          ...
          if (this.eat(acorn.tokTypes.colon)) {
            ...
            !prop.computed &&
            (prop.key.name === "get" || prop.key.name === "set") &&
            this.tok.type !== acorn.tokTypes.comma &&
            this.tok.type !== acorn.tokTypes.braceR &&
      ...
      lp.parsePropertyName = function (prop) {
        ...
        var key =
          this.tok.type === acorn.tokTypes.num || this.tok.type === acorn.tokTypes.string
            ? this.parseExprAtom()
            : this.parseIdent();
      ...
      lp.parseIdent = function () {
        ...
        if (this.tok.type.keyword) {
          this.toks.type = acorn.tokTypes.name;
        }
        var node = this.startNode();
        this.next();
        node.name = name;
      ...
      enter(n, parent) {
        ...
        const ignoredIdentifiers =
          ...
          (n._ignoredIdentifiers = [
            // @ts-expect-error
            ...((parent == null ? void 0 : parent._ignoredIdentifiers) ||
          ...
          case "Identifier": {
            ...
            const pNode = exp
              ? isAcorn
                ...
                : (0, node_js_1.patchBabelNodeLoc)(n, exp)
              : n;
            bindings.push({
              type: "Binding",
              // @ts-expect-error not correct type
            ...
            const declarations = node.declarations.flatMap((x) => {
              ...
              return bindings
                .filter((x2) => {
                  ...
                  return (
                    x2.type === "Binding" &&
                    !((_a3 = x2.parent) == null ? void 0 : _a3.type.startsWith("TS"))
                  );
                })
                .map((b) => {
                  return {
          ...
          const declarations = node.declarations.flatMap((x) => {
            ...
            const items = bindings
              .filter((x2) => {
                ...
                return (
                  x2.type === "Binding" &&
                  !((_a2 = x2.parent) == null ? void 0 : _a2.type.startsWith("TS"))
                );
              })
              .map((b) => {
                return {
...
function requireSetup() {
  ...
  (function (exports) {
    var __createBinding =
      (setup$1 && setup$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
...
function requireOptions() {
  ...
  (function (exports) {
    var __createBinding =
      (options$1 && options$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (options$1 && options$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
function requireConditions$1() {
  ...
  function handleConditions(node, parent, parentContext) {
    ...
    const prop = node.props.find(
      (prop2) =>
        prop2.type === compiler_core_1.NodeTypes.DIRECTIVE &&
        (prop2.name === "if" || prop2.name === "else-if" || prop2.name === "else"),
    );
    if (!prop) {
      return null;
    }
...
function requireConditions() {
  ...
  (function (exports) {
    var __createBinding =
      (conditions$1 && conditions$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (conditions$1 && conditions$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
function requireLoops$1() {
  ...
  function handleLoopProp(node, parent, parentContext) {
    ...
    const forProp = node.props.find(
      (x) => x.type === compiler_core_1.NodeTypes.DIRECTIVE && "forParseResult" in x,
    );
    if (!forProp) {
      return null;
    }
    const sourceBindings = forProp.forParseResult.source
      ? (0, utils_1.retrieveBindings)(forProp.forParseResult.source, parentContext)
      : [];
    const keyBindings = forProp.forParseResult.key
      ? (0, utils_1.retrieveBindings)(forProp.forParseResult.key, parentContext)
      : [];
    const valueBindings = forProp.forParseResult.value
      ? (0, utils_1.retrieveBindings)(forProp.forParseResult.value, parentContext)
      : [];
    const indexBindings = forProp.forParseResult.index
      ? (0, utils_1.retrieveBindings)(forProp.forParseResult.index, parentContext)
      : [];
    const items = [];
...
function requireLoops() {
  ...
  (function (exports) {
    var __createBinding =
      (loops$1 && loops$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
...
function requireProps() {
  ...
  (function (exports) {
    var __createBinding =
      (props$1 && props$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
...
function requireSlots$1() {
  ...
  function handleSlotProp(node, parent, parentContext, condition) {
    ...
    const propDirective = node.props.find(
      (x) => x.type === compiler_core_1.NodeTypes.DIRECTIVE && x.name === "slot",
    );
    if (!propDirective) {
      return null;
    }
    ...
    const ignoredIdentifiers =
      ((_a = prop.exp) == null ? void 0 : _a.map((x) => x.type === "Binding" && x.name)) ?? [];
    const context =
    ...
    const slot = {
      ...
      prop,
      parent:
        node.type === compiler_core_1.NodeTypes.ELEMENT && node.tag !== "template" ? null : parent,
      element: node,
      name: prop.arg,
      context,
...
function requireSlots() {
  ...
  (function (exports) {
    var __createBinding =
      (slots$1 && slots$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
...
function requireElement$2() {
  ...
  function handleElement(node, parent, parentContext) {
    ...
    const props =
      (propBindings == null ? void 0 : propBindings.filter((x) => x.type === "Prop")) ?? [];
    const slot = (0, slots_1.handleSlotDeclaration)(node, parent, context);
    const propSlot = (0, slots_1.handleSlotProp)(
      node,
      parent,
      context,
      conditions == null ? void 0 : conditions.condition,
    );
    if (propSlot) {
    ...
    const element2 = {
      ...
      slot:
        (slot == null ? void 0 : slot.slot) ?? (propSlot == null ? void 0 : propSlot.slot) ?? null,
      context,
    };
    const items = [
...
function requireGeneric$1() {
  ...
  function parseGeneric(genericStr, offset = 0, prefix = "__VERTER__TS__") {
    ...
    const params =
      ((_a = body == null ? void 0 : body.typeParameters) == null ? void 0 : _a.params) ?? [];
    ...
    const declaration = items
      .map((x) => {
        ...
        return [name, constraint ? `extends ${constraint}` : void 0, `= ${defaultType || "any"}`]
          .filter(Boolean)
          .join(" ");
      })
      .join(", ");
...
function requireGeneric() {
  ...
  (function (exports) {
    var __createBinding =
      (generic$1 && generic$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (generic$1 && generic$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
`;
    ...
    const blocks = (0, index_js_1.extractBlocksFromDescriptor)(sfcParse.descriptor)
      .sort((a, b) => {
      ...
      .map((x) => {
        ...
        switch (languageId) {
          case "vue":
            const ast = (0, template_js_1.parseTemplate)(
              x.block.ast,
              x.block.content,
              generic == null ? void 0 : generic.names,
            );
            return {
              type: "template",
              lang: languageId,
          ...
          case "tsx": {
            ...
            if (x.tag.attributes.generic && x.tag.attributes.generic.value) {
              generic = (0, index_js_2.parseGeneric)(
...
function requireScript$2() {
  ...
  (function (exports) {
    var __createBinding =
      (script$2 && script$2.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (script$2 && script$2.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
function requireTemplate$4() {
  ...
  (function (exports) {
    var __createBinding =
      (template$4 && template$4.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (template$4 && template$4.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
function requireParser() {
  ...
  (function (exports) {
    var __createBinding =
      (parser$1 && parser$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (parser$1 && parser$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
function requireUtils$1() {
  ...
  function generateImport(items) {
    ...
    for (const [key, value] of Object.entries(grouped)) {
      ...
      imports.push(
        `import { ${toAdd.map((i) => (i.type ? `type ` : "") + i.name + (i.alias ? ` as ${i.alias}` : "")).join(", ")} } from "${key}";`,
      );
    }
    return imports.join("\n");
  }
...
function requireAttributes() {
  ...
  (function (exports) {
    var __createBinding =
      (attributes$1 && attributes$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (attributes$1 && attributes$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
function requireBinding$2() {
  ...
  (function (exports) {
    var __createBinding =
      (binding$3 && binding$3.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (binding$3 && binding$3.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
function requireFullContext$1() {
  ...
  fullContext.FullContextPlugin = (0, types_1.definePlugin)({
    ...
    post(s, ctx) {
      ...
      const typeStr = (0, utils_1.generateTypeString)(
        fullContext2,
        {
...
function requireFullContext() {
  ...
  (function (exports) {
    var __createBinding =
      (fullContext$1 && fullContext$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (fullContext$1 && fullContext$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
;export const ${name}=${defineComponent}(${options});`);
        ...
        const componentExport =
          (_a = ctx.block.result) == null
            ? void 0
            : _a.items.find((x) => x.type === "DefaultExport");
        if (!componentExport) {
          ctx.items.push({
            type: "import",
            from: "vue",
...
function requireScriptDefault() {
  ...
  (function (exports) {
    var __createBinding =
      (scriptDefault$1 && scriptDefault$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (scriptDefault$1 && scriptDefault$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
function requireImports() {
  ...
  (function (exports) {
    var __createBinding =
      (imports$1 && imports$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (imports$1 && imports$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
function requireMacros$1() {
  ...
  const MacroDependencies = /* @__PURE__ */ new Map([
    ["defineEmits", ["UnionToIntersection", "EmitMapToProps", "OverloadParameters"]],
  ...
  macros.MacrosPlugin = (0, types_1.definePlugin)({
    ...
    post(s, ctx) {
      ...
      for (const macro of Macros) {
        ...
        if (itemMacro) {
          const str = (0, utils_1.generateTypeString)(
            name,
            {
          ...
          const str = (0, utils_1.generateTypeDeclaration)(
            name,
            "{}",
            (_a = ctx.generic) == null ? void 0 : _a.source,
            isTS,
          );
          s.append(str);
        }
    ...
    transformDeclaration(item, s, ctx) {
      ...
      if (
        ...
        ((_a = item.parent.init) == null ? void 0 : _a.type) === "CallExpression"
      ) {
    ...
    transformFunctionCall(item, s, ctx) {
      if (
        ...
        ctx.items.some(
          (x) =>
            (x.type === "macro-binding" || x.type === "define-model") && // check if is inside another macro
  ...
  function getModelName(node) {
    ...
    const modelName =
      (nameArg == null ? void 0 : nameArg.type) === "Literal"
        ? (((_a = nameArg.value) == null ? void 0 : _a.toString()) ?? "modelValue")
        : "modelValue";
    return modelName;
  }
  return macros;
...
function requireMacros() {
  ...
  (function (exports) {
    var __createBinding =
      (macros$1 && macros$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (macros$1 && macros$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
  ...
  scriptBlock.ScriptBlockPlugin = (0, types_1.definePlugin)({
    ...
    post(s, ctx) {
      ...
      const notMainScripts = ctx.blocks.filter(
        (block) => block.type === "script" && block.isMain === false,
      );
      ...
      for (const key in attributes) {
        if ((_a = ctx.handledAttributes) == null ? void 0 : _a.has(key)) continue;
...
function requireScriptBlock() {
  ...
  (function (exports) {
    var __createBinding =
      (scriptBlock$1 && scriptBlock$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (scriptBlock$1 && scriptBlock$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
  ...
  templateBinding.TemplateBindingPlugin = (0, types_1.definePlugin)({
    ...
    post(s, ctx) {
      ...
      if (!ctx.isSetup) {
        ...
        const typeStr2 = (0, utils_1.generateTypeString)(
          name,
          {
            from: `${name}FN`,
            isFunction: true,
      ...
      s.prependRight(
        ...
        `;return{${usedBindings
          .map(
            (x) =>
              `${x.name}/*${x.start},${x.end}*/: ${isTS ? `${x.name} as unknown as ${unwrapRef}<typeof ${x.name}>` : `${unref}(${x.name})`}`,
          )
          .concat(
      ...
      if (!isTS) {
        s.prependLeft(
          tag.pos.open.start,
          `/** @returns {{${usedBindings.map((x) => `${x.name}:${unwrapRef}<typeof ${x.name}>`).join(",")}}} */`,
        );
      }
      const typeStr = (0, utils_1.generateTypeString)(
        name,
...
function requireTemplateBinding() {
  ...
  (function (exports) {
    var __createBinding =
      (templateBinding$1 && templateBinding$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (templateBinding$1 && templateBinding$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
function requireTemplateRef$1() {
  ...
  function handleExpression(node, s, ctx) {
    ...
    const templateItems =
      (_b = (_a = ctx.blocks.find((x) => x.type === "template")) == null ? void 0 : _a.result) ==
      null
        ? void 0
        : _b.items.filter((x) => x.type === "Element");
    ...
    for (const item of templateItems) {
      ...
      const rawRefName =
        "arg" in ref
          ? // @ts-expect-error
            ...
            ((_h =
              (_g = (_f = ref.node.exp) == null ? void 0 : _f.ast) == null ? void 0 : _g.type) ==
            null
              ? void 0
              : _h.indexOf("Function")) !== -1
            ? ""
            : `typeof ${(_k = (_j = (_i = ref.exp) == null ? void 0 : _i[0]) == null ? void 0 : _j.exp) == null ? void 0 : _k.content}`
          : // @ts-expect-error
            `"${ref.value}"`;
      ...
      if (!name || name === refName) {
        ...
        for (const scriptItem of ctx.block.result.items) {
          if (scriptItem.type !== "Declaration") continue;
        ...
        (_a = item.props) == null
          ...
          : _a.find((x) => {
              ...
              return (
                ...
                (x.type === "Prop" &&
                  "arg" in x &&
                  ((_b = (_a2 = x.arg) == null ? void 0 : _a2[0]) == null ? void 0 : _b.name) ===
                    "is")
              );
            });
      if (!propIs) return;
  ...
  function retrieveDeclarationStringValueFromObject(item, path) {
    var _a, _b, _c;
    if (item.parent.type !== "VariableDeclarator") return void 0;
    const init = item.parent.init;
    if (!init || init.type !== "ObjectExpression") return void 0;
    const parts = path.split(".");
    if (item.name !== parts.shift()) return void 0;
    let object = init;
    while (parts.length) {
...
function requireTemplateRef() {
  ...
  (function (exports) {
    var __createBinding =
      (templateRef$1 && templateRef$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (templateRef$1 && templateRef$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
function requireSfcCleaner$2() {
  ...
  (function (exports) {
    var __createBinding =
      (sfcCleaner$3 && sfcCleaner$3.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (sfcCleaner$3 && sfcCleaner$3.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
function requireResolvers$1() {
  ...
  resolvers.ScriptResolversPlugin = (0, types_1.definePlugin)({
    ...
    post(s, ctx) {
      ...
      s.append(
        [
          (0, utils_1.generateTypeDeclaration)(
            resolvePropsName,
            resolveProps,
            (_a = ctx.generic) == null ? void 0 : _a.source,
            ctx.isTS,
          ...
          (0, utils_1.generateTypeDeclaration)(
            resolveEmitsName,
            resolveEmits,
            (_b = ctx.generic) == null ? void 0 : _b.source,
            ctx.isTS,
          ),
          ,
        ]
...
function requireResolvers() {
  ...
  (function (exports) {
    var __createBinding =
      (resolvers$1 && resolvers$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (resolvers$1 && resolvers$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
function requireComponentInstance() {
  ...
  (function (exports) {
    var __createBinding =
      (componentInstance$1 && componentInstance$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (componentInstance$1 && componentInstance$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
function requireDefineOptions() {
  ...
  (function (exports) {
    var __createBinding =
      (defineOptions$1 && defineOptions$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (defineOptions$1 && defineOptions$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
function requirePlugins$1() {
  ...
  (function (exports) {
    var __createBinding =
      (plugins$1 && plugins$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (plugins$1 && plugins$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
function requireMain$1() {
  ...
  function buildOptions(items, context) {
    ...
    return (0, script_1.processScript)(
      items,
      [
      ...
      ],
      {
        ...context,
        templateBindings: (
          (_a = template == null ? void 0 : template.result) == null ? void 0 : _a.items
        )
          ? (_b = template.result) == null
            ? void 0
            : _b.items.filter((x) => x.type === "Binding")
          : [],
      },
    );
  }
      ...
      [
        {
          post: (s, ctx) => {
            ...
            const compName = (0, vue_1.capitalize)(
              (0, vue_1.camelize)(
                ((_a = ctx.filename.split("/").pop()) == null ? void 0 : _a.split(".").shift()) ??
                  "Comp",
              ),
            );
            const genericDeclaration = ctx.generic ? `<${ctx.generic.declaration}>` : "";
...
function requireBundle() {
  ...
  (function (exports) {
    var __createBinding =
      (bundle$1 && bundle$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (bundle$1 && bundle$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
function requireBuilders$1() {
  ...
  (function (exports) {
    var __createBinding =
      (builders$1 && builders$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (builders$1 && builders$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
function requireScript() {
  ...
  (function (exports) {
    var __createBinding =
      (script$1 && script$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (script$1 && script$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
function requireBinding$1() {
  ...
  binding.BindingPlugin = {
    ...
    transformBinding(item, s, ctx) {
      ...
      if (
        ((_b = item.parent) == null ? void 0 : _b.type) === "ObjectProperty" &&
        item.parent.shorthand
      ) {
...
function requireBinding() {
  ...
  (function (exports) {
    var __createBinding =
      (binding$1 && binding$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (binding$1 && binding$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
  ...
  block.BlockPlugin = (0, template_1.declareTemplatePlugin)({
    ...
    post(s, ctx) {
      for (const [parent, block2] of this.conditions) {
        ...
        s[`${behaviour}${(conditions == null ? void 0 : conditions.blockDirection) ?? "Left"}`](
          ...
          ctx.doNarrow(
            {
              ...
              type: behaviour,
              direction:
                (conditions == null ? void 0 : conditions.blockDirection) === "Right"
                  ? "right"
                  : "left",
              condition: null,
              parent,
...
function requireBlock() {
  ...
  (function (exports) {
    var __createBinding =
      (block$1 && block$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
...
function requireComment() {
  ...
  (function (exports) {
    var __createBinding =
      (comment$1 && comment$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (comment$1 && comment$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
function requireConditional$1() {
  ...
  function generateConditionText(conditions, s) {
    ...
    const positive = conditions
      .map((x) => s.slice(x.node.loc.start.offset, x.node.loc.end.offset).toString())
      .filter((x) => x)
      .map((x) => {
...
function requireConditional() {
  ...
  (function (exports) {
    var __createBinding =
      (conditional$1 && conditional$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (conditional$1 && conditional$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
function requireInterpolation() {
  ...
  (function (exports) {
    var __createBinding =
      (interpolation$1 && interpolation$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (interpolation$1 && interpolation$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
function requireDirective$1() {
  ...
  directive.DirectivePlugin = (0, template_1.declareTemplatePlugin)({
    ...
    handleDirectiveModifiers(node, context, s, ctx) {
      ...
      const declaration = `const ${instanceToDirectiveVar}=${instanceToDirectiveFn}(${slotInstance});const ${directiveName}=${instanceToDirectiveVar}(${directiveAccessor}.${
    ...
    transformDirective(item, s, ctx) {
      ...
      switch (item.name) {
        case "model": {
          ...
          const fallbakName =
            element.tagType === compiler_core_1.ElementTypes.ELEMENT ? "value" : "modelValue";
          let bindingTo =
            element.tagType === compiler_core_1.ElementTypes.ELEMENT ? "input" : "modelValue";
          let isDynamic = false;
          if (node.arg) {
            const arg = node.arg;
          ...
          if (node.exp) {
            ...
            const eventName =
              element.tagType === compiler_core_1.ElementTypes.ELEMENT
                ? "onInput"
                : isDynamic
                  ? "onUpdate"
                  : `onUpdate:${bindingTo}`;
...
function requireDirective() {
  ...
  (function (exports) {
    var __createBinding =
      (directive$1 && directive$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (directive$1 && directive$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
    ...
    transformProp(prop2, s, ctx) {
      ...
      if (prop2.node === null) {
        ...
        const firstDirective = nodes.find(
          (x) => x.type === compiler_core_1.NodeTypes.DIRECTIVE && x.exp,
        );
        if (!firstDirective) {
          return;
        }
        ...
        for (let i = 0; i < nodes.length; i++) {
          ...
          const loc =
            node.type === compiler_core_1.NodeTypes.DIRECTIVE
              ? (_c = node.exp ?? node.arg) == null
                ? void 0
                : _c.loc
              : (_d = node.value) == null
                ? void 0
        ...
        (prop2.name === "is" ||
          (prop2.node.type === compiler_core_1.NodeTypes.DIRECTIVE &&
            prop2.node.rawName === ":is")) &&
        prop2.element.tag === "component"
      ) {
        return;
        ...
        if (
          (nameBinding == null ? void 0 : nameBinding.ignore) === true ||
          (nameBinding == null ? void 0 : nameBinding.skip)
        ) {
        ...
        if ((_f = node.rawName) == null ? void 0 : _f.startsWith("v-bind:")) {
          ...
          if ((nameBinding == null ? void 0 : nameBinding.ignore) === true) {
            s.overwrite(
              ...
              ((_i = nameBinding.name.at(0)) == null ? void 0 : _i.toUpperCase()) ?? "",
            );
          }
          ...
          if ((nameBinding == null ? void 0 : nameBinding.ignore) === true) {
            s.overwrite(
              ...
              ((_k = nameBinding.name.at(0)) == null ? void 0 : _k.toUpperCase()) ?? "",
            );
          }
        ...
        if ((_l = node.arg) == null ? void 0 : _l.loc.source.startsWith("[")) {
          ...
          if (node.exp) {
            ...
            s.appendLeft(
              node.loc.end.offset,
              `={${accessor}.${(0, vue_1.camelize)(nameBinding.name)}}`,
            );
          }
        }
  ...
  slot.SlotPlugin = (0, template_1.declareTemplatePlugin)({
    ...
    transformSlotRender(slot2, s, ctx) {
      ...
      if (slot2.parent) {
        ...
        if (node.type === compiler_core_1.NodeTypes.ELEMENT) {
          ...
          const tagEnd = node.isSelfClosing
            ...
            : node.loc.source
                .slice(
                  0,
                  (((_a = node.children[0]) == null ? void 0 : _a.loc.start.offset) ??
                    node.loc.end.offset - "</template>".length) - node.loc.start.offset,
                )
          ...
          if (prop.type === "Directive") {
            ...
            const end =
              start +
              (((_b = prop.node.rawName) == null ? void 0 : _b.startsWith("v-slot:")) ? 7 : 1);
            s.prependLeft(start, `${slotRender}(${slotInstance}.`);
            s.overwrite(start, end, `$slots`);
            if (prop.node.arg) {
              if (
                prop.node.arg.type === compiler_core_1.NodeTypes.SIMPLE_EXPRESSION &&
        ...
        s.overwrite(
          slot2.prop.node.loc.start.offset,
          slot2.prop.node.loc.start.offset +
...
function requireEvent() {
  ...
  (function (exports) {
    var __createBinding =
      (event$1 && event$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
  ...
  loop.LoopPlugin = (0, template_1.declareTemplatePlugin)({
    ...
    transformLoop(item, s, ctx) {
      ...
      const fromIndex = Math.max(
        (key == null ? void 0 : key.loc.end.offset) ?? 0,
        (index == null ? void 0 : index.loc.end.offset) ?? 0,
        (value == null ? void 0 : value.loc.end.offset) ?? 0,
      );
...
function requireLoop() {
  ...
  (function (exports) {
    ...
    Object.defineProperty(exports, "LoopPlugin", {
      enumerable: true,
      get: function () {
    ...
    transformElement(item, s, ctx) {
      ...
      const closingTagStartIndex = node.isSelfClosing
        ...
        : node.loc.source.lastIndexOf(
            `</${item.tag}`,
            ((_a = node.children.at(-1)) == null ? void 0 : _a.loc.end.offset) ?? void 0,
          ) + 2;
      const shouldWrap = item.tag.includes("-");
      const isProp = node.props.find(
        (x) =>
          x.name === "is" ||
          (x.type === compiler_core_1.NodeTypes.DIRECTIVE && x.rawName === ":is"),
      );
...
function requireElement() {
  ...
  (function (exports) {
    var __createBinding =
      (element$1 && element$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (element$1 && element$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
function requireTemplateTag() {
  ...
  (function (exports) {
    ...
    Object.defineProperty(exports, "TemplateTagPlugin", {
      enumerable: true,
      get: function () {
...
function requireSfcCleaner() {
  ...
  (function (exports) {
    var __createBinding =
      (sfcCleaner$1 && sfcCleaner$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (sfcCleaner$1 && sfcCleaner$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
function requireContext$1() {
  ...
  context.ContextPlugin = {
    ...
    pre(s, ctx) {
      const isSetup =
        ctx.blocks.find((x) => x.type === "script" && x.block.tag.attributes.setup) !== void 0;
...
function requireContext() {
  ...
  (function (exports) {
    var __createBinding =
      (context$1 && context$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (context$1 && context$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
function requirePlugins() {
  ...
  (function (exports) {
    var __createBinding =
      (plugins && plugins.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
...
function requireTemplate$2() {
  ...
  (function (exports) {
    var __createBinding =
      (template$3 && template$3.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __setModuleDefault =
      (template$3 && template$3.__setModuleDefault) ||
      (Object.create
        ? function (o, v) {
    ...
    var __exportStar =
      (template$3 && template$3.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
    ...
    var __importStar =
      (template$3 && template$3.__importStar) ||
      /* @__PURE__ */ (function () {
...
function requireStyles() {
  ...
  (function (exports) {
    var __createBinding =
      (styles$1 && styles$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (styles$1 && styles$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
function requireTemplate() {
  ...
  (function (exports) {
    var __createBinding =
      (template$1 && template$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (template$1 && template$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
function requireBuilders() {
  ...
  (function (exports) {
    var __createBinding =
      (builders && builders.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (builders && builders.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
function requireProcess() {
  ...
  (function (exports) {
    var __createBinding =
      (process$1 && process$1.__createBinding) ||
      (Object.create
        ? function (o, m, k, k2) {
            if (k2 === void 0) k2 = k;
            var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var __exportStar =
      (process$1 && process$1.__exportStar) ||
      function (m, exports2) {
        for (var p in m)
          if (p !== "default" && !Object.prototype.hasOwnProperty.call(exports2, p))
            __createBinding(exports2, m, p);
...
const init = ({ typescript: ts }) => {
  const create = (info) => {
        ...
        return moduleNames.map((moduleName, index) => {
          try {
            const resolvedModule = moduleResolver(moduleName, () => {
              ...
              return (
                // @ts-expect-error
                (_a = languageServiceHost.getResolvedModuleWithFailedLookupLocationsFromCache) ==
                  null
                  ? void 0
                  : _a.call(languageServiceHost, moduleName, containingFile)
              );
            });
            if (resolvedModule) return resolvedModule;
          } catch (e) {
    ...
    const createModuleResolver = (containingFile) => (moduleName, resolveModule) => {
      ...
      failedLocations.reduce((locations, location) => {
