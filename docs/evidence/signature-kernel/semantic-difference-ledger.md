...
capability. `SDL-10` has MOVED to Class 1 as well: it was a path-walker
defect, not an owed constrained-substitution stage. The
...
| Signature corpus `MatchesChecker` rows | **15 of 26**: `SV01`, `SV02`, `SV03`, `SV09`, `SV11`, `SV12`, `SV13`, `SV14`, `SV15`, `SV16`, `SV17`, `SV18`, `SV19`, `SV20`, `SV22` — the union-valued and mixed-arm `then` residuals, the construct-signature intersection instance side, explicit type arguments, the constrained indexed access, both 7.0.2 grouping witnesses, the transparent intersection group, and seven Awaited residuals. The live answers are structural matches of the recorded 7.0.2 observations, compared through the typed checker-syntax projection at the altitude the checker prints (utility applications reduced, named declarations kept by name). |
