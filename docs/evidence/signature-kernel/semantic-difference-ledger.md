...
| Signature corpus `MatchesChecker` rows | **16 of 26**: `SV01`, `SV02`, `SV03`, `SV04`, `SV09`, `SV12`, `SV13`, `SV14`, `SV15`, `SV16`, `SV17`, `SV18`, `SV19`, `SV20`, `SV22`, `SV26` — the union-valued and mixed-arm `then` residuals, the construct-signature intersection instance side, the mixin construct intersection over a class expression, explicit type arguments, both 7.0.2 grouping witnesses, the transparent intersection group, seven Awaited residuals, and the literal/generic union probe. The live answers are structural matches of the recorded 7.0.2 observations, compared through the typed checker-syntax projection at the altitude the checker prints (utility applications reduced, named declarations kept by name). |
