...
[`verter_audit`](../../crates/verter_audit/src/lib.rs) — the leaf
...
lifecycle) lives in
[`verter_session`](../../crates/verter_session/src/host_audit_runtime.rs).
...
[`verter_audit::payloads`](../../crates/verter_audit/src/payloads/mod.rs):
...
[`verter_audit::payloads::tags`](../../crates/verter_audit/src/payloads/tags.rs)
...
[`verter_audit::observer::AuditObserver`](../../crates/verter_audit/src/observer.rs)
...
[`AuditRequestRegistration`](../../crates/verter_session/src/host_audit_runtime.rs)
...
[`crates/verter_napi/src/audit.rs`](../../crates/verter_napi/src/audit.rs)
and [`crates/verter_napi/src/lib.rs`](../../crates/verter_napi/src/lib.rs).
...
[`crates/verter_wasm/src/lib.rs`](../../crates/verter_wasm/src/lib.rs)
