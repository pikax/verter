...
optional=false
release_gating=none
source_refs=source:successor-expansion.md:L968
...
- **PER0-AC1 — sole-owner proof:** add `per0_rejects_displaced_authority`; planting any deleted route must make the targeted gate fail.
- **PER0-AC2 — positive contract:** add `per0_publishes_exact_carrierprofileid`; assert exact identities, provenance, completeness, and deterministic ordering.
- **PER0-AC3 — incremental equivalence:** add `per0_incremental_equals_fresh`; cancellation/stale/partial outcomes must be refused from warm publication.
- **PER0-AC4 — bounded work:** capture equivalent-work counters for the named surfaces; no extra parse, resolve, plan, emit, copy, allocation, or retained candidate is hidden by wall time.
...
- `source:successor-expansion.md:L968`
...
- Kind: `context`
- Source: `compiler-proposal.md:1935-1935`
- Applicability: `PER0`
- Exact text SHA-256: `c36fec9b0d78f156feff1bd8f1bfc5c901d53480bfc3900d5bd77877eed425e1`
...
- Kind: `context`
- Source: `compiler-proposal.md:1937-1937`
- Applicability: `PER0`
- Exact text SHA-256: `2322f3485f7a746c6c358c61a0dcfd0d5f80c2151d963baa982a275ff51ffdb5`
...
- Kind: `context`
- Source: `successor-expansion.md:968-968`
- Applicability: `PER0`
- Exact text SHA-256: `86074df950e6484ab5ac20c6d43efc51869804ee18de65b427e2a0fe4ba0fcb8`
...
- Kind: `forbidden`
- Source: `successor-expansion.md:970-975`
- Applicability: `PER0`
- Exact text SHA-256: `de4e3f21cbdff9edc69ee7db6fad74e47efec0c763d8f2dd6acc60ccfa0063ad`
