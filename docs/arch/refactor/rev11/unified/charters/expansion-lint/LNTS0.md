...
optional=false
release_gating=none
source_refs=source:successor-expansion.md:L1446
...
- **LNTS0-AC1 — sole-owner proof:** add `lnts0_rejects_displaced_authority`; planting any deleted route must make the targeted gate fail.
- **LNTS0-AC2 — positive contract:** add `lnts0_publishes_exact_ruleid`; assert exact identities, provenance, completeness, and deterministic ordering.
- **LNTS0-AC3 — incremental equivalence:** add `lnts0_incremental_equals_fresh`; cancellation/stale/partial outcomes must be refused from warm publication.
- **LNTS0-AC4 — bounded work:** capture equivalent-work counters for the named surfaces; no extra parse, resolve, plan, emit, copy, allocation, or retained candidate is hidden by wall time.
...
- `source:successor-expansion.md:L1446`
...
### SRC-EXP-L1446-BE7E573B8630

- Kind: `context`
- Source: `successor-expansion.md:1446-1446`
- Applicability: `LNTS0`
- Exact text SHA-256: `be7e573b8630f21e59932413c76c780626889f02686eefb9e0939ed5f5b13d5b`

~~~~markdown
### `LNTS0.md` — Svelte lint compatibility and Verter-native pack
~~~~

### SRC-EXP-L1448-91907D467BE2

- Kind: `forbidden`
- Source: `successor-expansion.md:1448-1453`
- Applicability: `LNTS0`
- Exact text SHA-256: `91907d467be2455baeb38ac60eeab1761ec6ed55741aea00e88dc8864866f688`
