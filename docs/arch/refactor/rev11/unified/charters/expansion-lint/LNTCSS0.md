...
optional=false
release_gating=none
source_refs=source:successor-expansion.md:L1455
...
- **LNTCSS0-AC1 — sole-owner proof:** add `lntcss0_rejects_displaced_authority`; planting any deleted route must make the targeted gate fail.
- **LNTCSS0-AC2 — positive contract:** add `lntcss0_publishes_exact_ruleid`; assert exact identities, provenance, completeness, and deterministic ordering.
- **LNTCSS0-AC3 — incremental equivalence:** add `lntcss0_incremental_equals_fresh`; cancellation/stale/partial outcomes must be refused from warm publication.
- **LNTCSS0-AC4 — bounded work:** capture equivalent-work counters for the named surfaces; no extra parse, resolve, plan, emit, copy, allocation, or retained candidate is hidden by wall time.
...
- `source:successor-expansion.md:L1455`
...
- Kind: `context`
- Source: `successor-expansion.md:1455-1455`
- Applicability: `LNTCSS0`
- Exact text SHA-256: `73fdbb1abc4ccf4c5074c24130febe41436d83c6d2ec7917714d73983e4a9968`
...
- Kind: `forbidden`
- Source: `successor-expansion.md:1457-1462`
- Applicability: `LNTCSS0`
- Exact text SHA-256: `aa8464b44defd9f29688c0a48d39f6a89f1cf2ea9e7d51722c225dc432b9fac6`
