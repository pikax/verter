...
optional=false
release_gating=none
source_refs=source:successor-expansion.md:L1327
...
- **FMT1-AC1 — sole-owner proof:** add `fmt1_rejects_displaced_authority`; planting any deleted route must make the targeted gate fail.
- **FMT1-AC2 — positive contract:** add `fmt1_publishes_exact_doc`; assert exact identities, provenance, completeness, and deterministic ordering.
- **FMT1-AC3 — incremental equivalence:** add `fmt1_incremental_equals_fresh`; cancellation/stale/partial outcomes must be refused from warm publication.
- **FMT1-AC4 — bounded work:** capture equivalent-work counters for the named surfaces; no extra parse, resolve, plan, emit, copy, allocation, or retained candidate is hidden by wall time.
...
- `source:successor-expansion.md:L1327`
...
- Kind: `context`
- Source: `successor-expansion.md:1327-1327`
- Applicability: `FMT1`
- Exact text SHA-256: `b53306b41688bc94c6fa5ddb1efebcbae116c1b02755f492d5ed2471aae8b902`
...
- Kind: `forbidden`
- Source: `successor-expansion.md:1329-1334`
- Applicability: `FMT1`
- Exact text SHA-256: `a65691ab3f9f10f5f42938413c4ab1d7ff32a7c8fac8d4db50ab3c46f2d31a71`
