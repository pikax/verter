...
optional=false
release_gating=none
source_refs=source:successor-expansion.md:L1132
...
- **FMTH0-AC1 — sole-owner proof:** add `fmth0_rejects_displaced_authority`; planting any deleted route must make the targeted gate fail.
- **FMTH0-AC2 — positive contract:** add `fmth0_publishes_exact_doc`; assert exact identities, provenance, completeness, and deterministic ordering.
- **FMTH0-AC3 — incremental equivalence:** add `fmth0_incremental_equals_fresh`; cancellation/stale/partial outcomes must be refused from warm publication.
- **FMTH0-AC4 — bounded work:** capture equivalent-work counters for the named surfaces; no extra parse, resolve, plan, emit, copy, allocation, or retained candidate is hidden by wall time.
...
- `source:successor-expansion.md:L1132`
...
- Kind: `context`
- Source: `successor-expansion.md:1132-1132`
- Applicability: `FMTH0`
- Exact text SHA-256: `d2e90b968296a7dd38c168eeb2cd5293c44b28c8e77c28ea5a605527a1ff5ac4`
...
- Kind: `forbidden`
- Source: `successor-expansion.md:1134-1139`
- Applicability: `FMTH0`
- Exact text SHA-256: `75ee2abbe9a0e493a8b17a3bb614bde764afb2b2bd4708eea364f8a0cf9320ac`
