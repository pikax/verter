...
optional=false
release_gating=none
source_refs=source:successor-expansion.md:L1363
...
- **FMTV0-AC1 — sole-owner proof:** add `fmtv0_rejects_displaced_authority`; planting any deleted route must make the targeted gate fail.
- **FMTV0-AC2 — positive contract:** add `fmtv0_publishes_exact_doc`; assert exact identities, provenance, completeness, and deterministic ordering.
- **FMTV0-AC3 — incremental equivalence:** add `fmtv0_incremental_equals_fresh`; cancellation/stale/partial outcomes must be refused from warm publication.
- **FMTV0-AC4 — bounded work:** capture equivalent-work counters for the named surfaces; no extra parse, resolve, plan, emit, copy, allocation, or retained candidate is hidden by wall time.
...
- `source:successor-expansion.md:L1363`
...
### SRC-EXP-L1363-478B4084ED32

- Kind: `context`
- Source: `successor-expansion.md:1363-1363`
- Applicability: `FMTV0`
- Exact text SHA-256: `478b4084ed32e0612155e15c95170abaf22c65bff5af20ceb017051f5cf51f07`

~~~~markdown
### `FMTV0.md` — Vue whole-document formatter and atomic cutover
~~~~

### SRC-EXP-L1365-D7A1BE04D20B

- Kind: `forbidden`
- Source: `successor-expansion.md:1365-1370`
- Applicability: `FMTV0`
- Exact text SHA-256: `d7a1be04d20b9f86f2dcde4bd1084169cc3b69a28d7fe3fad54cc6a699483698`
