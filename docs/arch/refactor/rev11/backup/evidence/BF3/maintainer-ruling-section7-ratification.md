...
Reproduced verbatim below as issued. Nothing in the body has been edited, reordered or
summarized; this header is the only added text. The separately-ratified amendment Ruling 2
renumbers lands in the tree as `AMD-010`. The maintainer's own ratification act, given
directly in session, is the section titled "VERBATIM MAINTAINER RATIFICATION ACT"; it
supersedes the paraphrased intent capture that precedes it.
