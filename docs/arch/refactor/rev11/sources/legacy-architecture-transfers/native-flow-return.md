...
- Implementation action (facts): warm validity records through the EXISTING
  ...
  `verter_semantic::facts::registry` — see the block Changes); it and its selected IDs are never
