...
- **The editor-engine selection path is abandoned.** The rejection write-up
  (`03-editor-engine-selection-rejection.md`) is part of the recovered handoff set and is
  not rehomed in this backlog; see [`README.md`](README.md) for what is included here.
