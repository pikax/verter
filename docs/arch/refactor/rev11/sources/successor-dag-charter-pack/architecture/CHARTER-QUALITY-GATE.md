...
17. **Source reconciliation** — durable legacy clauses only, digest-bound before deletion.

Contract/constitution nodes may have zero production LOC, but their schemas, source atoms, generators, and negative guards are still real acceptance artifacts.
...
- validate current receipts and generated manifests;
...
- emit immutable product receipts and capability snapshots.
