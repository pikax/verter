...
- **External custody maintainer_bundled_engine_shipping:** require the exact immutable authorization slot at dispatch and a finalized-candidate-bound authorization before evidence or acceptance.
