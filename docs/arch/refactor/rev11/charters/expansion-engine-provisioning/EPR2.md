...
- **EPR1:** exact current receipt ID and digest for “Engine artifact identity, compatibility, integrity, and cache contract”; Git ancestry, touched-blob integration equivalence, and receipt currency must validate at dispatch and acceptance.
...
- **External custody maintainer_managed_engine_acquisition:** require the exact immutable authorization slot at dispatch and a finalized-candidate-bound authorization before evidence or acceptance.
