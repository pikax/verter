...
- **EPR4:** exact current receipt ID and digest for “Exact authorized engine candidate resolution and selection”; Git ancestry, touched-blob integration equivalence, and receipt currency must validate at dispatch and acceptance.
...
- Kind: `requirement`
- Source: `legacy-arch-reconciliation.md:181-186`
- Applicability: `EPR5`, `EPR6`
- Exact text SHA-256: `8ccd7625df8c8294d21aeb4f157e3c5860e4ea6c4c42c2f0cb6670dde7f25bc5`
