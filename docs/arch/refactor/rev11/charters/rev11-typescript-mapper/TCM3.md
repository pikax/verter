...
optional=false
release_gating=none
source_refs=live:docs/arch/refactor/rev11/charters/TCM3.md
...
- **TCM3-AC1 — sole-owner proof:** add `tcm3_rejects_displaced_authority`; planting any deleted route must make the targeted gate fail.
- **TCM3-AC2 — positive contract:** add `tcm3_publishes_exact_certifiedtypeenginebinding`; assert exact identities, provenance, completeness, and deterministic ordering.
- **TCM3-AC3 — incremental equivalence:** add `tcm3_incremental_equals_fresh`; cancellation/stale/partial outcomes must be refused from warm publication.
- **TCM3-AC4 — bounded work:** capture equivalent-work counters for the named surfaces; no extra parse, resolve, plan, emit, copy, allocation, or retained candidate is hidden by wall time.
...
- `live:docs/arch/refactor/rev11/charters/TCM3.md`
...
- `live:docs/arch/refactor/rev11/charters/TCM3.md` — 18634 bytes, SHA-256 `b9add050be307cd3ff369453f164b78e8a58adb30df1c5e9ead98f8951b7e54c`
