...
optional=false
release_gating=none
source_refs=source:successor-expansion.md:L1298
...
- **ASTP-AC1 — sole-owner proof:** add `astp_rejects_displaced_authority`; planting any deleted route must make the targeted gate fail.
- **ASTP-AC2 — positive contract:** add `astp_publishes_exact_carrierprofile`; assert exact identities, provenance, completeness, and deterministic ordering.
- **ASTP-AC3 — incremental equivalence:** add `astp_incremental_equals_fresh`; cancellation/stale/partial outcomes must be refused from warm publication.
- **ASTP-AC4 — bounded work:** capture equivalent-work counters for the named surfaces; no extra parse, resolve, plan, emit, copy, allocation, or retained candidate is hidden by wall time.
...
- `source:successor-expansion.md:L1298`
...
### SRC-EXP-L1298-7BACD625FD28

- Kind: `context`
- Source: `successor-expansion.md:1298-1298`
- Applicability: `ASTP`
- Exact text SHA-256: `7bacd625fd287ecf29f4811f2f365cbd7b01244f28d914d251f0b643661affe3`

~~~~markdown
### `ASTP.md` — Astro heterogeneous-carrier tooling proof
~~~~

### SRC-EXP-L1300-76CDD3BB5B47

- Kind: `forbidden`
- Source: `successor-expansion.md:1300-1305`
- Applicability: `ASTP`
- Exact text SHA-256: `76cdd3bb5b472670b2566d30b242e9bc9d0d28a2f96c43d75698ace7c0354872`
