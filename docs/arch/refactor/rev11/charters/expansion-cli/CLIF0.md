...
optional=false
release_gating=none
source_refs=source:successor-expansion.md:L1538
...
- **FMT4:** exact current receipt ID and digest for “Formatter LSP/public parity, conformance, and promotion”; Git ancestry, touched-blob integration equivalence, and receipt currency must validate at dispatch and acceptance.
...
- **CLIF0-AC1 — sole-owner proof:** add `clif0_rejects_displaced_authority`; planting any deleted route must make the targeted gate fail.
- **CLIF0-AC2 — positive contract:** add `clif0_publishes_exact_applicationservices`; assert exact identities, provenance, completeness, and deterministic ordering.
- **CLIF0-AC3 — incremental equivalence:** add `clif0_incremental_equals_fresh`; cancellation/stale/partial outcomes must be refused from warm publication.
- **CLIF0-AC4 — bounded work:** capture equivalent-work counters for the named surfaces; no extra parse, resolve, plan, emit, copy, allocation, or retained candidate is hidden by wall time.
...
- `source:successor-expansion.md:L1538`
...
- Kind: `context`
- Source: `successor-expansion.md:1538-1538`
- Applicability: `CLIF0`
- Exact text SHA-256: `f0b895f9a6bd21a70356517864a15c220ba5f2b848e697d9ccf681b86f085a18`
...
- Kind: `forbidden`
- Source: `successor-expansion.md:1540-1545`
- Applicability: `CLIF0`
- Exact text SHA-256: `f1efa702b87d91dc023d0882db0aa8606df839b33d4d3fb6a7ae374b6456d446`
