...
- **NCK0:** exact current receipt ID and digest for “Native diagnostic authority and parity-certification constitution”; Git ancestry, touched-blob integration equivalence, and receipt currency must validate at dispatch and acceptance.
...
### SRC-LEGACY-NCK-REGION-001

- Kind: `requirement`
- Source: `legacy-arch-reconciliation.md:31-36`
- Applicability: `NCK1`, `NCK5`
- Exact text SHA-256: `dd90f040fccb7717fbd3176795bac24cf4f6ea2fcdb4a542611e9d331b304dbd`
