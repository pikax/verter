...
- Production surfaces: `docs/arch/refactor/rev11/authority`, `crates/verter_session`, `crates/verter_semantic`, `crates/verter_diagnostics`, `crates/verter_lsp`, `crates/verter_bench`.
...
- **NCK7:** exact current receipt ID and digest for “Shared diagnostic service and consumer-surface integration”; Git ancestry, touched-blob integration equivalence, and receipt currency must validate at dispatch and acceptance.
- **NCKF0:** exact current receipt ID and digest for “Required native checker diagnostic-family convergence”; Git ancestry, touched-blob integration equivalence, and receipt currency must validate at dispatch and acceptance.
