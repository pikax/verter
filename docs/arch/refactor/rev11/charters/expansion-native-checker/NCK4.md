...
- Production surfaces: `docs/arch/refactor/rev11/catalogs`, `docs/arch/refactor/rev11/generated`, `crates/verter_session/tests`, `crates/verter_diagnostics/tests`, `crates/verter_type_runtime`, `tools`.
...
- **NCK3:** exact current receipt ID and digest for “Shared-proof semantic diagnostic rule kernel”; Git ancestry, touched-blob integration equivalence, and receipt currency must validate at dispatch and acceptance.
...
### SRC-LEGACY-TRANSFER-B373C0B55059

- Kind: `requirement`
- Source: `legacy-architecture-transfers.md:593-598`
- Applicability: `NCK4`, `TCM3`
- Exact text SHA-256: `708931d4d1ded4b5a6f303f7f1bca13f24e3bfb19f445bbf1b8783e3730c5d7c`

~~~~markdown
### LEGACY-TRANSFER-B373C0B55059

- Original path: `docs/arch/u0-oracle-harness-design.md`; Git blob: `b373c0b55059e37c8eadae0829b1cb7ab32e173c`; exact source SHA-256: `330715924f301f40cefa18ce0ae008aea5344a06c29d84f49485271a5df616f2`.
- Exact retained source: `sources/legacy-architecture-transfers/u0-oracle-harness-design.md`.
- Applicable authority: `NCK4`, `TCM3`.
