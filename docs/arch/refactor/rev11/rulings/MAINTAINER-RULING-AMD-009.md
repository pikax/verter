...
AMD-009 MUST NOT be committed until BF3 lands. Committing to
...
dispatch, AMD-009 ratification, or any ledger transition.
...
- Unchanged: JS-1 gates nothing — not AMD-009 ratification, not B3 dispatch, not any ledger
