# Exact operative source-clause attachment — NCF-MP-MODULE

Schema: 1. Node: `NCF-MP-MODULE`. Clause count: 5. Generated from `provenance/source-coverage.toml`; every clause below is exact, operative, and applicable to this node.
