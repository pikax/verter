# Exact operative source-clause attachment — NCF-OC-MERGE

Schema: 1. Node: `NCF-OC-MERGE`. Clause count: 5. Generated from `provenance/source-coverage.toml`; every clause below is exact, operative, and applicable to this node.
