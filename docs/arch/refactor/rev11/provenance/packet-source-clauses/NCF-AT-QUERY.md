# Exact operative source-clause attachment — NCF-AT-QUERY

Schema: 1. Node: `NCF-AT-QUERY`. Clause count: 5. Generated from `provenance/source-coverage.toml`; every clause below is exact, operative, and applicable to this node.
