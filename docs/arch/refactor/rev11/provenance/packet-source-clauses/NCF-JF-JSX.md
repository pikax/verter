# Exact operative source-clause attachment — NCF-JF-JSX

Schema: 1. Node: `NCF-JF-JSX`. Clause count: 5. Generated from `provenance/source-coverage.toml`; every clause below is exact, operative, and applicable to this node.
