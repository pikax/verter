# Exact operative source-clause attachment — NCF-AT-REDUCE

Schema: 1. Node: `NCF-AT-REDUCE`. Clause count: 5. Generated from `provenance/source-coverage.toml`; every clause below is exact, operative, and applicable to this node.
