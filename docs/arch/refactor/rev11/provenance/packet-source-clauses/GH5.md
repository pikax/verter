# Exact operative source-clause attachment — GH5

Schema: 1. Node: `GH5`. Clause count: 5. Generated from `provenance/source-coverage.toml`; every clause below is exact, operative, and applicable to this node.
...
- Kind: `requirement`; source: `github-control-plane-program.md:271-334`; target: `node:GH5`; text SHA-256: `4c449b679066cde8750208d206e68b793e412db59a0f97e31f3ca5027030ff91`.
