# Exact operative source-clause attachment — NCKF0

Schema: 1. Node: `NCKF0`. Clause count: 2. Generated from `provenance/source-coverage.toml`; every clause below is exact, operative, and applicable to this node.
