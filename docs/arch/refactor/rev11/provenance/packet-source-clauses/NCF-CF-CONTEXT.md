# Exact operative source-clause attachment — NCF-CF-CONTEXT

Schema: 1. Node: `NCF-CF-CONTEXT`. Clause count: 5. Generated from `provenance/source-coverage.toml`; every clause below is exact, operative, and applicable to this node.
