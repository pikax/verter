# Exact operative source-clause attachment — NCF-BD-INIT

Schema: 1. Node: `NCF-BD-INIT`. Clause count: 5. Generated from `provenance/source-coverage.toml`; every clause below is exact, operative, and applicable to this node.
