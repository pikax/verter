# Exact operative source-clause attachment — REL1

Schema: 1. Node: `REL1`. Clause count: 4. Generated from `provenance/source-coverage.toml`; every clause below is exact, operative, and applicable to this node.
...
- Kind: `requirement`; source: `github-control-plane-program.md:547-568`; target: `node:REL1`; text SHA-256: `7ab6db8c467141f62cacafee5319b3bf7b9b42a59531c50aa3495559e2c77b23`.
