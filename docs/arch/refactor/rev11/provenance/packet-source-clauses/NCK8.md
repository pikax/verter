# Exact operative source-clause attachment — NCK8

Schema: 1. Node: `NCK8`. Clause count: 3. Generated from `provenance/source-coverage.toml`; every clause below is exact, operative, and applicable to this node.

### SRC-LEGACY-NCK-SURFACE-001

- Kind: `requirement`; source: `legacy-arch-reconciliation.md:62-66`; target: `node:NCK7`; text SHA-256: `80bb125bd976d6c582f8b9ccd44ac69efe608f2eef261b9523bf2c9810e439a0`.
