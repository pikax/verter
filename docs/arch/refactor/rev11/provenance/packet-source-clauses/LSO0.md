# Exact operative source-clause attachment — LSO0

Schema: 1. Node: `LSO0`. Clause count: 4. Generated from `provenance/source-coverage.toml`; every clause below is exact, operative, and applicable to this node.
...
- Kind: `requirement`; source: `legacy-architecture-transfers.md:453-458`; target: `node:LSO0`; text SHA-256: `8de4e609efe8c048168adf3f843fd89ecbf6b4ce1d355cf6baa291392ff700e8`.
