# Exact operative source-clause attachment — NCF-JD-JS

Schema: 1. Node: `NCF-JD-JS`. Clause count: 5. Generated from `provenance/source-coverage.toml`; every clause below is exact, operative, and applicable to this node.
