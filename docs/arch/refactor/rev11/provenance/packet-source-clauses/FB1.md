# Exact operative source-clause attachment — FB1

Schema: 1. Node: `FB1`. Clause count: 4. Generated from `provenance/source-coverage.toml`; every clause below is exact, operative, and applicable to this node.

### SRC-GITHUB-FB1-BLOCK

- Kind: `requirement`; source: `github-control-plane-program.md:389-449`; target: `node:FB1`; text SHA-256: `77743b832f084b87bcdd061672b8b3fdbcc02fc0f0b6141ba0fbb2415b51ae6f`.
