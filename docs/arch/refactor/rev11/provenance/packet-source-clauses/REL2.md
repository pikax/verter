# Exact operative source-clause attachment — REL2

Schema: 1. Node: `REL2`. Clause count: 4. Generated from `provenance/source-coverage.toml`; every clause below is exact, operative, and applicable to this node.
...
- Kind: `requirement`; source: `github-control-plane-program.md:570-615`; target: `node:REL2`; text SHA-256: `a512ce0df15c99ba64886672f2183a46acb61e6bc088468c288358a4af396016`.
