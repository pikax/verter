# Exact operative source-clause attachment — NCF-JD-JSDOC

Schema: 1. Node: `NCF-JD-JSDOC`. Clause count: 5. Generated from `provenance/source-coverage.toml`; every clause below is exact, operative, and applicable to this node.
