# Exact operative source-clause attachment — NCF-MP-AUG

Schema: 1. Node: `NCF-MP-AUG`. Clause count: 5. Generated from `provenance/source-coverage.toml`; every clause below is exact, operative, and applicable to this node.
