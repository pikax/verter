# Exact operative source-clause attachment — GH1

Schema: 1. Node: `GH1`. Clause count: 5. Generated from `provenance/source-coverage.toml`; every clause below is exact, operative, and applicable to this node.
...
- Kind: `requirement`; source: `github-control-plane-program.md:63-95`; target: `node:GH1`; text SHA-256: `f50e990a38c165bae598925866c2097242adfd1ea349ee09cbb0a47635180782`.
