# Exact operative source-clause attachment — GH0

Schema: 1. Node: `GH0`. Clause count: 5. Generated from `provenance/source-coverage.toml`; every clause below is exact, operative, and applicable to this node.
...
- Kind: `requirement`; source: `github-control-plane-program.md:47-61`; target: `node:GH0`; text SHA-256: `5b9cbdc1973a32cd25f335c1d9af76dfe056e3e31eb7250c6cd626092c8ee36f`.
