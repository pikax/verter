# Exact operative source-clause attachment — GH4

Schema: 1. Node: `GH4`. Clause count: 5. Generated from `provenance/source-coverage.toml`; every clause below is exact, operative, and applicable to this node.
...
- Kind: `requirement`; source: `github-control-plane-program.md:220-269`; target: `node:GH4`; text SHA-256: `36f90c318494dd0a2cc62c660a991cf55f732bdb097da57310224b8f8c06a815`.
