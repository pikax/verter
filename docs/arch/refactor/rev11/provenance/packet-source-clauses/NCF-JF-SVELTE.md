# Exact operative source-clause attachment — NCF-JF-SVELTE

Schema: 1. Node: `NCF-JF-SVELTE`. Clause count: 5. Generated from `provenance/source-coverage.toml`; every clause below is exact, operative, and applicable to this node.
