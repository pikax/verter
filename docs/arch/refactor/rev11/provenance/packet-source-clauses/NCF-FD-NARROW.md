# Exact operative source-clause attachment — NCF-FD-NARROW

Schema: 1. Node: `NCF-FD-NARROW`. Clause count: 5. Generated from `provenance/source-coverage.toml`; every clause below is exact, operative, and applicable to this node.
