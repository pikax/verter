# Exact operative source-clause attachment — NCF-CO-CALL

Schema: 1. Node: `NCF-CO-CALL`. Clause count: 5. Generated from `provenance/source-coverage.toml`; every clause below is exact, operative, and applicable to this node.
