...
export function classifyNextestFailures(text) {
...
export function analyzeNextestSurface(text, code) {
  const failures = [];
...
export function analyzeLibtestSurface(text, code, binaryId) {
...
// ----------------------------------------------------------------------------------------------------
export function buildCargoEnv(baseEnv, runnerTarget) {
  const env = { ...baseEnv };
