...
function constructCases() {
  return [
    ...
    { axis: "const_type_annotation", source: "const y: OnlyType = realX;", probes: ["y", "realX", "OnlyType"] },
    ...
    { axis: "namespace_type_only", source: "namespace TypeNs { export type T = number; }", probes: ["TypeNs"] },
    { axis: "namespace_value", source: "namespace ValueNs { export const V = 1; }", probes: ["ValueNs", "V"] },
    // A lone bodiless overload signature erases.
    { axis: "function_lone_overload", source: "function loneOverload(a: number): void;", probes: ["loneOverload"] },
    ...
    { axis: "satisfies_expression", source: "const sv = other satisfies Ty;", probes: ["sv", "other", "Ty"] },
    { axis: "non_null_expression", source: "const nn = thing!;", probes: ["nn", "thing"] },
    { axis: "instantiation_expression", source: "const iv = generic<Ty>;", probes: ["iv", "generic", "Ty"] },
    ...
    { axis: "type_assertion_angle", source: "const ta = <Foo>realX;", probes: ["ta", "realX", "Foo"] },
    ...
    { axis: "class_declare_field", source: "class DF { declare [DK]: number; }", probes: ["DF", "DK"] },
    ...
    { axis: "abstract_method", source: "abstract class AM { abstract m(P: number): void; }", probes: ["AM", "P", "m"] },
    ...
    { axis: "class_param_property", source: "class PP { constructor(public X: number) {} }", probes: ["PP", "X"] },
    ...
    { axis: "class_index_signature", source: "class C { [k: string]: number }", probes: ["C"], expect_crash: true },
    ...
    { axis: "function_expression_this", source: "const fe = function inner(this: ThisT, a) { return a; };", probes: ["fe", "inner", "a", "ThisT"] },
    { axis: "function_declaration_this", source: "function fd(this: ThisT, b) { return b; }", probes: ["fd", "b", "ThisT"] },
  ];
}
...
function buildRows(compiler) {
  ...
  for (const c of constructCases()) {
    ...
    const disposition = officialOutcome(compiler, c.source, NEGATIVE_CONTROL, c.expect_crash === true);
