...
describe('diagnostics', () => {
  it('strips ansi sequences and parses TS diagnostics', () => {
    const raw = '\u001b[96msrc/App.vue\u001b[0m:\u001b[93m12\u001b[0m:\u001b[93m5\u001b[0m - \u001b[91merror\u001b[0m TS2322: Type "string" is not assignable to type "number".';
  ...
  it('diffs vue-tsc and verter-tsc diagnostics into reviewable classes', () => {
    const normalized = normalizeTypeCheckArtifacts({
      ...
      vueTsc: {
        cold: { ms: 10, exitCode: 0, errorCount: 1, timedOut: false, stdout: '', stderr: 'src/App.vue:1:1 - error TS2322: Shared issue\n' },
        warm: { ms: 8, exitCode: 0, errorCount: 1, timedOut: false, stdout: '', stderr: 'src/App.vue:1:1 - error TS2322: Shared issue\n' },
      },
      verterTsc: {
        cold: { ms: 9, exitCode: 0, errorCount: 2, timedOut: false, stdout: '', stderr: 'src/App.vue:1:1 - error TS2322: Shared issue\nsrc/Strict.vue:2:3 - error TS2345: Extra strict issue\n' },
        warm: { ms: 7, exitCode: 0, errorCount: 2, timedOut: false, stdout: '', stderr: 'src/App.vue:1:1 - error TS2322: Shared issue\nsrc/Strict.vue:2:3 - error TS2345: Extra strict issue\n' },
      },
    }, 'D:\\repo');
