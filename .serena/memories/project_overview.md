...
- TypeScript packages own SFC-to-TSX package surfaces, TypeScript utility types, bundler/plugin integration, VS Code/client glue, docs, benchmarks, playground, and package distribution wrappers.
...
- `packages/`: pnpm workspace packages including `@verter/core`, `@verter/component-meta`, `@verter/native`, `@verter/wasm`, `@verter/unplugin`, `@verter/types`, `@verter/language-shared`, `@verter/typescript-plugin`, `@verter/playground`, `@verter/benchmark`, `@verter/proto`, `@verter/verter-tsc`, and `verter-vscode`.
