...
// Event handling patterns for parser testing - Setup API + TypeScript
...
function handleFormSubmitWithModifier(): void {
...
function handleCustomEvent(payload: CustomEventPayload): void {
  console.log("Custom event received", payload);
}

// Multiple arguments handler
function handleWithArgs(arg1: string, arg2: number, event: MouseEvent): void {
  console.log("Args:", arg1, arg2, event);
}

// Inline expression variables
const dynamicEventName = ref<string>("click");
