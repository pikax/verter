...
// Conditional rendering patterns for parser testing - Setup API + TypeScript
...
const user = ref<{ name: string; role: string } | null>({ name: "John", role: "admin" });
...
const config = ref<{ settings?: { advanced?: boolean } } | undefined>({
