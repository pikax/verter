...
// Reactive values for CSS v-bind
...
<template>
  <div class="css-demo">
    ...
    <!-- Scoped styles with :deep, :global, :slotted -->
    <section>
...
/* :deep() - affects child components */
.scoped-demo :deep(.deep-target) {
  color: purple;
  font-weight: bold;
}

/* :slotted() - affects slotted content */
...
<style module>
/* CSS Modules - auto-scoped with unique names */
.container {
  padding: 15px;
