...
export default defineComponent({
  ...
  data() {
    return {
      showAsync: false,
      showDynamic: false,
      componentName: "ComponentA" as "ComponentA" | "ComponentB",
      currentRoute: "dashboard" as "dashboard" | "settings" | "profile",
      userId: 1,
      preloadedComponent: null as Component | null,
      lazyComponents,
    };
  },
  computed: {
  ...
  methods: {
    ...
    setRoute(route: "dashboard" | "settings" | "profile"): void {
