<script lang="ts">
// Class and Style binding patterns for parser testing - Options API + TypeScript
...
export default defineComponent({
  ...
  data() {
    return {
      ...
      isHighlighted: true as boolean,

      // Dynamic class name
      dynamicClassName: "custom-class" as string,
      ...
      baseClass: "base" as string,
      activeClass: "active" as string,
      errorClass: "error" as string,

      // Inline style bindings
      activeColor: "red" as string,
      fontSize: 16 as number,
      marginValue: 10 as number,
      ...
      primaryColor: "#3498db" as string,
      secondaryColor: "#2ecc71" as string,
  ...
  computed: {
    computedClassObject(): Record<string, boolean> {
      return {
    ...
    computedStyleObject(): Record<string, string> {
      return {
        color: this.isActive ? this.activeColor : "gray",
        fontSize: `${this.fontSize}px`,
        marginTop: `${this.marginValue}px`,
      };
    },
